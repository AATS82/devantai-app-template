...
const DEFAULT_DATA = {
    ...
    imagen_hero: "https://images.unsplash.com/photo-1606811841689-23db3c3298c0?w=1800&q=80",
    imagen_nosotros: "https://images.unsplash.com/photo-1631217b52f4-2df7ad5d4aa7?w=800&q=80",
    servicios: [
        { titulo: "{{SERVICIO_1}}", descripcion: "{{DESC_1}}", icon: "tooth" },
        { titulo: "{{SERVICIO_2}}", descripcion: "{{DESC_2}}", icon: "smile" },
...
// SVG Icons
const Icons = {
    tooth: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2c-3 0-5 2-5 5v12c0 1.5 1 3 3 3h4c2 0 3-1.5 3-3V7c0-3-2-5-5-5z" /><path d="M10 8h4M10 12h4M10 16h2" /></svg>),
...
function HeroCentered({ d, primary, primaryRgb, fontTitulo, scrollTo, BG, BG2, TEXT, MUTED, BORDER, isDark }) {
    return (
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", background: BG }}>
            <div style={{ position: "absolute", inset: 0, backgroundImage: `url('${d.imagen_hero || 'https://images.unsplash.com/photo-1606811841689-23db3c3298c0?w=1800&q=80'}')`, backgroundSize: "cover", backgroundPosition: "center", filter: isDark ? "brightness(0.3)" : "brightness(0.95)" }} />
            ...
            <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 120, background: isDark ? `linear-gradient(to bottom right, transparent 49%, ${BG} 50%)` : `linear-gradient(to bottom right, transparent 49%, ${BG} 50%)` }} />
            <div style={{ position: "relative", textAlign: "center", padding: "0 1.5rem", maxWidth: 780, zIndex: 1 }}>
                ...
                <h1 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "clamp(3rem, 8vw, 5.5rem)", fontWeight: 700, lineHeight: 1.0, letterSpacing: "-0.01em", marginBottom: "1.25rem", color: TEXT }}>{d.nombre}</h1>
                ...
                <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
                    <button className="btn-primary" style={{ padding: "1rem 2.5rem", fontSize: "1rem", borderRadius: "8px" }} onClick={() => scrollTo("contacto")}>Agendar Cita</button>
    ...
    return (
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr", overflow: "hidden" }}>
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "8rem 3rem 4rem 4rem", background: BG, zIndex: 1 }}>
                ...
                <h1 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "clamp(2.5rem, 5vw, 4.5rem)", fontWeight: 700, lineHeight: 1.0, letterSpacing: "-0.01em", marginBottom: "1.25rem", color: TEXT }}>{d.nombre}</h1>
                <p style={{ fontSize: "1.1rem", color: MUTED, marginBottom: "2.5rem", lineHeight: 1.7, maxWidth: 420 }}>{d.slogan || d.descripcion}</p>
                <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
                    <button className="btn-primary" style={{ padding: "1rem 2rem", fontSize: "0.95rem", borderRadius: "8px" }} onClick={() => scrollTo("contacto")}>Agendar Cita</button>
            ...
            <div style={{ position: "relative", overflow: "hidden" }}>
                <div style={{ position: "absolute", inset: 0, backgroundImage: `url('${d.imagen_hero || 'https://images.unsplash.com/photo-1606811841689-23db3c3298c0?w=1800&q=80'}')`, backgroundSize: "cover", backgroundPosition: "center" }} />
                ...
                <AnimatedSection key={i} delay={i * 100}>
                    <div className="service-card">
                        ...
                        <div style={{ padding: "2rem", display: "flex", gap: "1.5rem", alignItems: "flex-start" }}>
                            <div style={{ width: 64, height: 64, minWidth: 64, borderRadius: "50%", background: `rgba(${primaryRgb},0.15)`, border: `1.5px solid rgba(${primaryRgb},0.3)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary }}>
                                <span style={{ width: 28, height: 28 }}>{Icons[s.icon] || Icons.tooth}</span>
                            </div>
                            <div>
                                <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1.3rem", fontWeight: 600, marginBottom: "0.5rem", color: TEXT }}>{s.titulo}</h3>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {(d.servicios || []).map((s, i) => (
                <AnimatedSection key={i} delay={i * 80}>
                    <div style={{ display: "flex", alignItems: "center", gap: "2rem", padding: "1.75rem 2rem", background: BG2, border: `1px solid ${BORDER}`, borderLeft: `4px solid ${primary}`, transition: "all 0.3s", borderRadius: "12px" }}
                        onMouseOver={e => e.currentTarget.style.background = `rgba(${primaryRgb},0.05)`}
                        onMouseOut={e => e.currentTarget.style.background = BG2}>
                        <div style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "2.8rem", fontWeight: 700, color: `rgba(${primaryRgb},0.2)`, minWidth: 60, lineHeight: 1 }}>
                            {String(i + 1).padStart(2, "0")}
                        </div>
                        <div style={{ width: 40, height: 40, minWidth: 40, color: primary }}>
                            <span style={{ width: 28, height: 28, display: "block" }}>{Icons[s.icon] || Icons.tooth}</span>
                        </div>
                        <div>
                ...
                <AnimatedSection>
                    <div className="service-card" style={{ height: "100%" }}>
                        ...
                        <div style={{ padding: "3rem 2.5rem" }}>
                            <div style={{ width: 72, height: 72, borderRadius: "50%", background: `rgba(${primaryRgb},0.15)`, border: `1.5px solid rgba(${primaryRgb},0.4)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, marginBottom: "1.5rem" }}>
                                <span style={{ width: 36, height: 36 }}>{Icons[featured.icon] || Icons.tooth}</span>
                            </div>
                            <div style={{ fontSize: "0.7rem", fontFamily: `'${fontTitulo}', serif`, letterSpacing: "0.2em", textTransform: "uppercase", color: primary, marginBottom: "0.75rem", fontWeight: 600 }}>Servicio Destacado</div>
                        ...
                        <div className="service-card">
                            ...
                            <div style={{ padding: "1.5rem", display: "flex", gap: "1rem", alignItems: "flex-start" }}>
                                <div style={{ width: 48, height: 48, minWidth: 48, borderRadius: "50%", background: `rgba(${primaryRgb},0.1)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary }}>
                                    <span style={{ width: 24, height: 24 }}>{Icons[s.icon] || Icons.tooth}</span>
                                </div>
                                <div>
                                    <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1rem", fontWeight: 600, marginBottom: "0.3rem", color: TEXT }}>{s.titulo}</h3>
...
function NosotrosImage({ d, BG, BG2, TEXT, MUTED, BORDER, isDark }) {
    return (
        <div style={{ position: "relative", borderRadius: "12px", overflow: "hidden", aspectRatio: "4/3" }}>
            <img
                src={d.imagen_nosotros || 'https://images.unsplash.com/photo-1631217b52f4-2df7ad5d4aa7?w=800&q=80'}
                alt="Nuestro equipo"
...
function NosotrosStats({ d, primary, fontTitulo, BG, BG2, TEXT, MUTED, BORDER, isDark }) {
    return (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
            {[
                { n: d.anos_experiencia, l: "Años de experiencia" },
                { n: d.clientes_atendidos, l: "Pacientes tratados" },
                { n: "99%", l: "Tasa de satisfacción" },
                { n: "24h", l: "Respuesta garantizada" },
            ].map((s, i) => (
                <div key={i} style={{ padding: "2rem", background: BG2, border: `1px solid ${BORDER}`, borderRadius: "12px", borderTop: `3px solid ${primary}` }}>
...
export default function LandingDentista({ data, onEnter }) {
    ...
    const primary = d.color_primario || '#0369a1';
    const secondary = d.color_secundario || '#0284c7';
    const fontTitulo = d.font_titulo || 'Lora';
    const fontCuerpo = d.font_cuerpo || 'Plus Jakarta Sans';
    const primaryRgb = hexToRgb(primary);
    const googleFontsUrl = `https://fonts.googleapis.com/css2?family=${fontTitulo.replace(/ /g, '+')}:wght@400;600;700&family=${fontCuerpo.replace(/ /g, '+')}:wght@400;500;600;700&display=swap`;
    ...
    const iniciales = (d.nombre || "DC").split(" ").slice(0, 2).map(w => w[0]).join("").toUpperCase();
        ...
        <div style={{ fontFamily: `'${fontCuerpo}', sans-serif`, background: BG, color: TEXT, overflowX: "hidden" }}>
            <style>{`
                ...
                * { margin: 0; padding: 0; box-sizing: border-box; }
                ...
                .btn-primary { background: var(--primary); color: #fff; border: none; cursor: pointer; font-family: '${fontCuerpo}', sans-serif; font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase; transition: all 0.2s; }
                .btn-primary:hover { background: var(--primary-dark); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(${primaryRgb},0.35); }
                .btn-outline { background: transparent; color: ${TEXT}; border: 1.5px solid ${BORDER}; cursor: pointer; font-family: '${fontCuerpo}', sans-serif; font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase; transition: all 0.2s; }
                ...
                .service-card:hover { border-color: var(--primary); transform: translateY(-4px); box-shadow: 0 12px 36px rgba(${primaryRgb},0.15); }
                ...
                .why-item { display: flex; gap: 1.25rem; align-items: flex-start; padding: 1.5rem; border-left: 3px solid transparent; transition: border-color 0.3s, background 0.3s; border-radius: 8px; }
            ...
            <nav style={{
                ...
                padding: "1rem 2rem",
                background: scrolled ? `rgba(${primaryRgb.split(',').slice(0,3).join(',')}, 0.08)` : "transparent",
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", cursor: "pointer" }} onClick={() => scrollTo("inicio")}>
                    <div style={{ width: 40, height: 40, background: primary, borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', serif`, fontWeight: 700, fontSize: "1rem", color: "#fff" }}>{iniciales}</div>
            ...
            {menuOpen && (
                <div style={{ position: "fixed", top: 65, left: 0, right: 0, zIndex: 999, background: BG2, borderBottom: `1px solid ${BORDER}`, padding: "1.5rem 2rem", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                    {["inicio", "servicios", "nosotros", "testimonios", "contacto"].map(s => (
                    ...
                    <button className="btn-primary" style={{ padding: "0.8rem", fontSize: "0.9rem", borderRadius: "8px" }} onClick={() => scrollTo("contacto")}>Agendar Cita</button>
                </div>
            )}
            ...
            <section id="servicios" style={{ background: BG2, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <p style={{ textAlign: "center", fontFamily: `'${fontTitulo}', serif`, fontWeight: 600, fontSize: "0.75rem", letterSpacing: "0.2em", textTransform: "uppercase", color: primary, marginBottom: "0.5rem" }}>Servicios dentales</p>
            ...
            <section id="nosotros" style={{ background: BG, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }} className="grid-2">
                    <AnimatedSection>
                        ...
                        <p style={{ fontFamily: `'${fontTitulo}', serif`, fontWeight: 600, fontSize: "0.75rem", letterSpacing: "0.2em", textTransform: "uppercase", color: primary, marginBottom: "0.5rem" }}>Por qué elegirnos</p>
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "clamp(2rem,4vw,2.8rem)", fontWeight: 700, lineHeight: 1.1, marginBottom: "1.5rem", color: TEXT }}>Cuidado dental de calidad superior</h2>
                        <p style={{ color: MUTED, lineHeight: 1.7, marginBottom: "2rem", fontSize: "1.05rem" }}>{d.descripcion}</p>
                        <button className="btn-primary" style={{ padding: "0.9rem 2rem", fontSize: "0.9rem", borderRadius: "8px" }} onClick={() => scrollTo("contacto")}>Agendar Cita Hoy</button>
                    </AnimatedSection>
                    <AnimatedSection delay={150}>
                        {(() => {
                            const props = { d, BG, BG2, TEXT, MUTED, BORDER, isDark, primary, fontTitulo, primaryRgb };
            ...
            <section id="testimonios" style={{ background: BG2, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <p style={{ textAlign: "center", fontFamily: `'${fontTitulo}', serif`, fontWeight: 600, fontSize: "0.75rem", letterSpacing: "0.2em", textTransform: "uppercase", color: primary, marginBottom: "0.5rem" }}>Testimonios</p>
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 700, marginBottom: "3.5rem", color: TEXT }}>Lo que dicen nuestros pacientes</h2>
                    </AnimatedSection>
                            ...
                            <AnimatedSection key={i} delay={i * 120}>
                                <div className="testim-card">
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                                        <div style={{ width: 40, height: 40, background: primary, borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', serif`, fontWeight: 700, fontSize: "1rem", color: "#fff" }}>
            ...
            <section id="contacto" style={{ background: BG, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <p style={{ textAlign: "center", fontFamily: `'${fontTitulo}', serif`, fontWeight: 600, fontSize: "0.75rem", letterSpacing: "0.2em", textTransform: "uppercase", color: primary, marginBottom: "0.5rem" }}>Contacto</p>
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 700, marginBottom: "3.5rem", color: TEXT }}>Agenda tu cita hoy</h2>
                    </AnimatedSection>
                    <div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: "4rem", alignItems: "start" }}>
                        <AnimatedSection>
                            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                                ...
                                <a href={waLink} target="_blank" rel="noopener noreferrer"
                                    style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.75rem", background: "#25d366", color: "#fff", padding: "1rem", fontFamily: `'${fontCuerpo}', sans-serif`, fontWeight: 600, letterSpacing: "0.05em", textTransform: "uppercase", fontSize: "1rem", transition: "background 0.2s", borderRadius: "8px" }}
                        ...
                        <AnimatedSection delay={150}>
                            <div style={{ background: BG2, border: `1px solid ${BORDER}`, padding: "2.5rem", borderRadius: "12px" }}>
                                <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1.4rem", fontWeight: 700, marginBottom: "1.5rem", color: TEXT }}>Envíanos un mensaje</h3>
                                <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                                    ...
                                    <button className="btn-primary" style={{ padding: "1rem", fontSize: "1rem", borderRadius: "8px", width: "100%", fontWeight: 700 }}>Enviar Mensaje</button>
                                </div>
                            </div>
                        </AnimatedSection>
                    </div>
            ...
            <footer style={{ background: BG3, borderTop: `1px solid ${BORDER}`, padding: "3rem 2rem 1.5rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "2rem", paddingBottom: "2rem", borderBottom: `1px solid ${BORDER}`, marginBottom: "1.5rem" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                            <div style={{ width: 36, height: 36, background: primary, borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', serif`, fontWeight: 700, color: "#fff" }}>{iniciales}</div>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
                        ...
                        <p style={{ color: "rgba(15,23,42,0.3)" + (isDark ? "" : ""), fontSize: "0.75rem", letterSpacing: "0.05em" }}>Powered by Devantai</p>
                    </div>
                </div>
            </footer>
