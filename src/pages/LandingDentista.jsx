...
const DEFAULT_DATA = {
    ...
    descripcion: "Ofrecemos soluciones odontológicas integrales con tecnología de punta y un equipo altamente capacitado para cuidar tu salud bucal.",
    ciudad: "Santiago, Chile",
    telefono: "+56 2 2345 6789",
    email: "contacto@smiledental.cl",
    horario: "Lunes a viernes: 9:00 - 19:00 | Sábados: 10:00 - 14:00",
    anos_experiencia: "15+",
    clientes_atendidos: "5000+",
    color_primario: "#0066cc",
    color_secundario: "#0052a3",
    font_titulo: "Poppins",
    font_cuerpo: "Inter",
    imagen_hero: "https://images.unsplash.com/photo-1606811841689-23e3b95bdc15?w=1800&q=80",
    imagen_nosotros: "https://images.unsplash.com/photo-1631217314830-4401ec54efee?w=800&q=80",
    hero_variant: "centered",
    servicios_variant: "grid",
    nosotros_variant: "image",
    servicios: [
        { titulo: "Limpieza dental", descripcion: "Profesionales que eliminan sarro y placa bacteriana para mantener tus dientes saludables", icon: "sparkles" },
        { titulo: "Blanqueamiento", descripcion: "Tratamientos modernos para obtener una sonrisa blanca y radiante en poco tiempo", icon: "smile" },
        { titulo: "Endodoncia", descripcion: "Tratamientos de conducto especializados para salvar tus dientes dañados", icon: "shield" },
        { titulo: "Implantes dentales", descripcion: "Soluciones permanentes y naturales para reemplazar dientes perdidos", icon: "award" },
    ],
    testimonios: [
        { nombre: "María González", cargo: "Paciente", texto: "Excelente atención. El equipo es muy profesional y hace sentir cómodo durante cada procedimiento. Recomiendo SmileDental sin dudarlo." },
        { nombre: "Carlos Rodríguez", cargo: "Paciente", texto: "Llevaba años sin ir al dentista y tenía mucho miedo. El Dr. López fue muy paciente y explicó cada paso. Ahora cuido mis dientes regularmente." },
        { nombre: "Andrea Martínez", cargo: "Paciente", texto: "El tratamiento de blanqueamiento fue rápido y efectivo. Mi sonrisa brilla más que nunca. ¡Muchas gracias por el excelente servicio!" },
    ],
};

// SVG Icons
const Icons = {
    sparkles: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9.26 9a2.5 2.5 0 0 1 3.48 0l8.75 8.75"/><path d="M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0z"/><path d="M9 9a3 3 0 0 1 3-3 3 3 0 0 1 3 3"/></svg>),
...
function HeroCentered({ d, primary, primaryRgb, fontTitulo, scrollTo }) {
    return (
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
            <div style={{ position: "absolute", inset: 0, backgroundImage: `url('${d.imagen_hero || 'https://images.unsplash.com/photo-1606811841689-23e3b95bdc15?w=1800&q=80'}')`, backgroundSize: "cover", backgroundPosition: "center", filter: "brightness(0.4)" }} />
            <div style={{ position: "absolute", inset: 0, background: `linear-gradient(135deg, rgba(15,23,42,0.87) 0%, rgba(${primaryRgb},0.15) 100%)` }} />
            <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 120, background: "linear-gradient(to bottom right, transparent 49%, #0f172a 50%)" }} />
            <div style={{ position: "relative", textAlign: "center", padding: "0 1.5rem", maxWidth: 780, zIndex: 1 }}>
                ...
                <p style={{ fontSize: "clamp(1rem, 2.5vw, 1.25rem)", color: "rgba(255,255,255,0.85)", maxWidth: 580, margin: "0 auto 2.5rem", lineHeight: 1.6 }}>{d.slogan || d.descripcion}</p>
...
function HeroSplit({ d, primary, primaryRgb, fontTitulo, scrollTo }) {
    return (
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr", overflow: "hidden" }}>
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "8rem 3rem 4rem 4rem", background: "#0f172a", zIndex: 1 }}>
                ...
                <p style={{ fontSize: "1.1rem", color: "rgba(255,255,255,0.8)", marginBottom: "2.5rem", lineHeight: 1.7, maxWidth: 420 }}>{d.slogan || d.descripcion}</p>
            ...
            <div style={{ position: "relative", overflow: "hidden" }}>
                <div style={{ position: "absolute", inset: 0, backgroundImage: `url('${d.imagen_hero || 'https://images.unsplash.com/photo-1606811841689-23e3b95bdc15?w=1800&q=80'}')`, backgroundSize: "cover", backgroundPosition: "center" }} />
                <div style={{ position: "absolute", inset: 0, background: `linear-gradient(to right, #0f172a 0%, transparent 30%, rgba(${primaryRgb},0.2) 100%)` }} />
                <div style={{ position: "absolute", left: 0, top: 0, bottom: 0, width: 80, background: "linear-gradient(to right, #0f172a, transparent)" }} />
            </div>
        </section>
    );
}
...
function HeroMinimal({ d, primary, primaryRgb, fontTitulo, scrollTo }) {
    return (
        <section id="inicio" style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#0f172a", borderBottom: `3px solid ${primary}`, overflow: "hidden" }}>
            <div style={{ textAlign: "center", padding: "0 1.5rem", maxWidth: 900 }}>
                ...
                <p style={{ fontSize: "clamp(1rem, 2vw, 1.2rem)", color: "rgba(255,255,255,0.7)", maxWidth: 560, margin: "0 auto 3rem", lineHeight: 1.7 }}>{d.slogan || d.descripcion}</p>
                <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
                    <button className="btn-primary" style={{ padding: "1rem 2.5rem", fontSize: "1rem", borderRadius: "8px" }} onClick={() => scrollTo("contacto")}>Agendar Cita</button>
                    <button className="btn-outline" style={{ padding: "1rem 2.5rem", fontSize: "1rem", borderRadius: "8px" }} onClick={() => scrollTo("servicios")}>Ver Servicios</button>
                </div>
                ...
                <AnimatedSection key={i} delay={i * 100}>
                    <div className="service-card">
                        ...
                        <div style={{ padding: "2rem", display: "flex", gap: "1.5rem", alignItems: "flex-start" }}>
                            ...
                            <div>
                                <h3 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "1.3rem", fontWeight: 700, textTransform: "capitalize", letterSpacing: "0.02em", marginBottom: "0.5rem" }}>{s.titulo}</h3>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {(d.servicios || []).map((s, i) => (
                <AnimatedSection key={i} delay={i * 80}>
                    <div style={{ display: "flex", alignItems: "center", gap: "2rem", padding: "1.75rem 2rem", background: "var(--bg3)", border: "1px solid var(--border)", borderLeft: `4px solid ${primary}`, borderRadius: "8px", transition: "all 0.3s" }}
                        ...
                        <div>
                            <h3 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "1.2rem", fontWeight: 700, textTransform: "capitalize", letterSpacing: "0.02em", marginBottom: "0.3rem" }}>{s.titulo}</h3>
                ...
                <AnimatedSection>
                    <div className="service-card" style={{ height: "100%" }}>
                        ...
                        <div style={{ padding: "3rem 2.5rem" }}>
                            ...
                            <h3 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "2rem", fontWeight: 800, textTransform: "capitalize", lineHeight: 1.1, marginBottom: "1rem" }}>{featured.titulo}</h3>
                    ...
                    <AnimatedSection key={i} delay={i * 100}>
                        <div className="service-card">
                            ...
                            <div style={{ padding: "1.5rem", display: "flex", gap: "1rem", alignItems: "flex-start" }}>
                                <div style={{ width: 40, height: 40, minWidth: 40, background: `rgba(${primaryRgb},0.1)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, borderRadius: "8px" }}>
                                    <span style={{ width: 20, height: 20 }}>{Icons[s.icon] || Icons.sparkles}</span>
                                </div>
                                <div>
                                    <h3 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "1rem", fontWeight: 700, textTransform: "capitalize", marginBottom: "0.3rem" }}>{s.titulo}</h3>
...
function NosotrosImage({ d }) {
    return (
        <div style={{ position: "relative", borderRadius: "8px", overflow: "hidden", aspectRatio: "4/3" }}>
            <img
                src={d.imagen_nosotros || 'https://images.unsplash.com/photo-1631217314830-4401ec54efee?w=800&q=80'}
                alt="Nuestro equipo"
    ...
    return (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
            {[
                ...
                { n: "98%", l: "Satisfacción garantizada" },
                { n: "24h", l: "Atención de emergencias" },
            ].map((s, i) => (
...
export default function LandingDentista({ data, onEnter }) {
    ...
    const primary = d.color_primario || '#0066cc';
    const secondary = d.color_secundario || '#0052a3';
    ...
    const iniciales = (d.nombre || "SD").split(" ").slice(0, 2).map(w => w[0]).join("").toUpperCase();
    ...
    return (
        <div style={{ fontFamily: `'${fontCuerpo}', sans-serif`, background: "#0f172a", color: "#f0f0f0", overflowX: "hidden" }}>
            <style>{`
                ...
                * { margin: 0; padding: 0; box-sizing: border-box; }
                ...
                .btn-outline { background: transparent; color: #fff; border: 1.5px solid rgba(255,255,255,0.4); cursor: pointer; font-family: '${fontTitulo}', sans-serif; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; transition: all 0.2s; border-radius: 8px; }
                .btn-outline:hover { border-color: #fff; background: rgba(255,255,255,0.08); }
                .service-card { background: var(--bg3); border: 1px solid var(--border); border-radius: 8px; overflow: hidden; transition: all 0.3s; }
                ...
                .testim-card { background: var(--bg3); border: 1px solid var(--border); border-radius: 8px; padding: 2rem; transition: border-color 0.3s; }
                .testim-card:hover { border-color: var(--accent); }
            ...
            {menuOpen && (
                <div style={{ position: "fixed", top: 65, left: 0, right: 0, zIndex: 999, background: "rgba(15,23,42,0.98)", borderBottom: "1px solid var(--border)", padding: "1.5rem 2rem", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                    {["inicio", "servicios", "nosotros", "testimonios", "contacto"].map(s => (
            ...
            <section style={{ background: primary, padding: "2rem" }}>
                <div className="stats-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", maxWidth: 900, margin: "0 auto", textAlign: "center", gap: "1rem" }}>
                    {[
                        { n: d.anos_experiencia, l: "Años de trayectoria" },
                        { n: d.clientes_atendidos, l: "Pacientes felices" },
                        { n: "98%", l: "Satisfacción" },
                        { n: "24h", l: "Emergencias atendidas" },
                    ].map((s, i) => (
                        <div key={i}>
            ...
            <section id="servicios" style={{ background: "var(--bg2)", padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <p style={{ textAlign: "center", fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 600, fontSize: "0.8rem", letterSpacing: "0.2em", textTransform: "uppercase", color: primary, marginBottom: "0.5rem" }}>Nuestros tratamientos</p>
                        <h2 style={{ fontFamily: `'${fontTitulo}', sans-serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 800, textTransform: "uppercase", letterSpacing: "-0.01em", marginBottom: "3.5rem" }}>Servicios Odontológicos</h2>
                    </AnimatedSection>
                    {(() => {
            ...
            <section id="nosotros" style={{ background: "var(--bg)", padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }} className="grid-2">
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "clamp(2rem,4vw,2.8rem)", fontWeight: 800, textTransform: "uppercase", lineHeight: 1.1, marginBottom: "1.5rem" }}>Tu salud bucal es nuestra misión</h2>
            ...
            <section id="testimonios" style={{ background: "var(--bg2)", padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <AnimatedSection>
                        <div className="divider"><div className="divider-line" /><div className="divider-dot" /><div className="divider-line" /></div>
                        <p style={{ textAlign: "center", fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 600, fontSize: "0.8rem", letterSpacing: "0.2em", textTransform: "uppercase", color: primary, marginBottom: "0.5rem" }}>Nuestros pacientes</p>
                        <h2 style={{ fontFamily: `'${fontTitulo}', sans-serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 800, textTransform: "uppercase", marginBottom: "3.5rem" }}>Historias de Éxito</h2>
                    </AnimatedSection>
                        ...
                        {(d.testimonios || []).map((t, i) => (
                            <AnimatedSection key={i} delay={i * 120}>
                                <div className="testim-card">
                                    ...
                                    <p style={{ color: "rgba(255,255,255,0.8)", lineHeight: 1.7, marginBottom: "1.5rem", fontSize: "0.95rem", fontStyle: "italic" }}>"{t.texto}"</p>
                                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                                        <div style={{ width: 40, height: 40, background: primary, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 800, fontSize: "1rem", borderRadius: "8px" }}>
            ...
            <section id="contacto" style={{ background: "var(--bg)", padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', sans-serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 800, textTransform: "uppercase", marginBottom: "3.5rem" }}>Agendar tu Cita</h2>
                    </AnimatedSection>
                    <div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: "4rem", alignItems: "start" }}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                                {[
                                    ...
                                    <div key={i} style={{ display: "flex", gap: "1rem", alignItems: "flex-start", padding: "1.25rem", background: "var(--bg3)", border: "1px solid var(--border)", borderRadius: "8px" }}>
                                        <div style={{ width: 42, height: 42, minWidth: 42, background: `rgba(${primaryRgb},0.12)`, border: `1px solid rgba(${primaryRgb},0.3)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, borderRadius: "8px" }}>
                        ...
                        <AnimatedSection delay={150}>
                            <div style={{ background: "var(--bg3)", border: "1px solid var(--border)", padding: "2.5rem", borderRadius: "8px" }}>
                                <h3 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "1.4rem", fontWeight: 700, textTransform: "uppercase", marginBottom: "1.5rem" }}>Reservar tu cita</h3>
                                <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                                    <input type="text" placeholder="Tu nombre completo" />
                                    <input type="tel" placeholder="Tu teléfono" />
                                    <input type="email" placeholder="Tu correo electrónico" />
                                    <textarea placeholder="Cuéntanos qué necesitas..." />
                                    <button className="btn-primary" style={{ padding: "1rem", fontSize: "1rem", borderRadius: "8px", width: "100%" }}>Agendar Cita</button>
                                </div>
                            </div>
                        </AnimatedSection>
                    </div>
            ...
            {/* ── FOOTER ── */}
            <footer style={{ background: "#081829", borderTop: "1px solid var(--border)", padding: "3rem 2rem 1.5rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "2rem", paddingBottom: "2rem", borderBottom: "1px solid var(--border)", marginBottom: "1.5rem" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                            <div style={{ width: 36, height: 36, background: primary, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 800, borderRadius: "8px" }}>{iniciales}</div>
