...
const DEFAULT_DATA = {
    ...
    imagen_hero: "https://images.unsplash.com/photo-1587854692152-cbe660dbde36?w=1800&q=80",
    imagen_nosotros: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=800&q=80",
    servicios: [
        { titulo: "{{SERVICIO_1}}", descripcion: "{{DESC_1}}", icon: "pills" },
...
// SVG Icons
const Icons = {
    pills: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="8" cy="8" r="6"/><circle cx="16" cy="16" r="6"/><path d="M14 14l-5-5"/></svg>),
        ...
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", background: BG }}>
            ...
            <div style={{ position: "relative", textAlign: "center", padding: "0 1.5rem", maxWidth: 780, zIndex: 1 }}>
                ...
                <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
                    <button className="btn-primary" style={{ padding: "1rem 2.5rem", fontSize: "1rem", borderRadius: "12px" }} onClick={() => scrollTo("contacto")}>Solicitar Asesoría</button>
        ...
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr", overflow: "hidden" }}>
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "8rem 3rem 4rem 4rem", background: BG, zIndex: 1 }}>
                ...
                <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
                    <button className="btn-primary" style={{ padding: "1rem 2rem", fontSize: "0.95rem", borderRadius: "12px" }} onClick={() => scrollTo("contacto")}>Solicitar Asesoría</button>
                ...
                <AnimatedSection key={i} delay={i * 100}>
                    <div className="service-card">
                        ...
                        <div style={{ padding: "2rem", display: "flex", gap: "1.5rem", alignItems: "flex-start" }}>
                            <div style={{ width: 56, height: 56, minWidth: 56, background: `rgba(${primaryRgb},0.15)`, border: `1px solid rgba(${primaryRgb},0.3)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, borderRadius: "50%" }}>
                                <span style={{ width: 28, height: 28 }}>{Icons[s.icon] || Icons.pills}</span>
                            </div>
                            <div>
                                <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1.3rem", fontWeight: 700, color: TEXT, marginBottom: "0.5rem" }}>{s.titulo}</h3>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {(d.servicios || []).map((s, i) => (
                <AnimatedSection key={i} delay={i * 80}>
                    <div style={{ display: "flex", alignItems: "center", gap: "2rem", padding: "1.75rem 2rem", background: BG2, border: `1px solid ${BORDER}`, borderLeft: `4px solid ${primary}`, borderRadius: "12px", transition: "all 0.3s" }}
                        ...
                        <div style={{ width: 40, height: 40, minWidth: 40, color: primary }}>
                            <span style={{ width: 28, height: 28, display: "block" }}>{Icons[s.icon] || Icons.pills}</span>
                        </div>
                        <div>
                            <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1.2rem", fontWeight: 700, color: TEXT, marginBottom: "0.3rem" }}>{s.titulo}</h3>
                    ...
                    <div className="service-card" style={{ height: "100%" }}>
                        ...
                        <div style={{ padding: "3rem 2.5rem" }}>
                            <div style={{ width: 64, height: 64, background: `rgba(${primaryRgb},0.15)`, border: `1px solid rgba(${primaryRgb},0.4)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, marginBottom: "1.5rem", borderRadius: "50%" }}>
                                <span style={{ width: 32, height: 32 }}>{Icons[featured.icon] || Icons.pills}</span>
                            </div>
                            ...
                            <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "2rem", fontWeight: 800, color: TEXT, lineHeight: 1.1, marginBottom: "1rem" }}>{featured.titulo}</h3>
                    ...
                    <AnimatedSection key={i} delay={i * 100}>
                        <div className="service-card">
                            ...
                            <div style={{ padding: "1.5rem", display: "flex", gap: "1rem", alignItems: "flex-start" }}>
                                <div style={{ width: 40, height: 40, minWidth: 40, background: `rgba(${primaryRgb},0.1)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, borderRadius: "50%" }}>
                                    <span style={{ width: 20, height: 20 }}>{Icons[s.icon] || Icons.pills}</span>
                                </div>
                                <div>
                                    <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1rem", fontWeight: 700, color: TEXT, marginBottom: "0.3rem" }}>{s.titulo}</h3>
        ...
        <div style={{ fontFamily: `'${fontCuerpo}', sans-serif`, background: BG, color: TEXT, overflowX: "hidden" }}>
            <style>{`
                ...
                * { margin: 0; padding: 0; box-sizing: border-box; }
                ...
                .btn-outline:hover { border-color: var(--primary); background: rgba(${primaryRgb},0.08); }
            ...
            <nav style={{
                ...
                padding: "1rem 2rem",
                background: scrolled ? `rgba(15,23,42,${isDark ? 0.97 : 0.95})` : "transparent",
                ...
                <div className="desktop-nav" style={{ display: "flex", alignItems: "center", gap: "2.5rem" }}>
                    ...
                    <button className="btn-primary" style={{ padding: "0.6rem 1.4rem", fontSize: "0.85rem", borderRadius: "12px" }} onClick={() => scrollTo("contacto")}>Asesoría Gratis</button>
                </div>
            ...
            {menuOpen && (
                <div style={{ position: "fixed", top: 65, left: 0, right: 0, zIndex: 999, background: `rgba(15,23,42,${isDark ? 0.98 : 0.95})`, borderBottom: `1px solid ${BORDER}`, padding: "1.5rem 2rem", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                    {["inicio", "servicios", "nosotros", "testimonios", "contacto"].map(s => (
                        <span key={s} className="nav-link" onClick={() => scrollTo(s)} style={{ textTransform: "capitalize", fontSize: "1.1rem" }}>{s}</span>
                    ))}
                    <button className="btn-primary" style={{ padding: "0.8rem", fontSize: "0.9rem", borderRadius: "12px" }} onClick={() => scrollTo("contacto")}>Asesoría Gratis</button>
                </div>
            )}
            ...
            <section id="servicios" style={{ background: BG2, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 800, color: TEXT, marginBottom: "3.5rem" }}>Nuestros Servicios</h2>
                    </AnimatedSection>
                    {(() => {
            ...
            <section id="nosotros" style={{ background: BG, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }} className="grid-2">
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "clamp(2rem,4vw,2.8rem)", fontWeight: 800, color: TEXT, lineHeight: 1.1, marginBottom: "1.5rem" }}>Tu salud es nuestra prioridad</h2>
            ...
            <section id="testimonios" style={{ background: BG2, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 800, color: TEXT, marginBottom: "3.5rem" }}>Lo que dicen de nosotros</h2>
                    </AnimatedSection>
            ...
            <section id="contacto" style={{ background: BG, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 800, color: TEXT, marginBottom: "3.5rem" }}>¿Necesitas asesoría?</h2>
                    </AnimatedSection>
                    <div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: "4rem", alignItems: "start" }}>
                        ...
                        <AnimatedSection delay={150}>
                            <div style={{ background: BG2, border: `1px solid ${BORDER}`, padding: "2.5rem", borderRadius: "12px" }}>
                                <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1.4rem", fontWeight: 700, color: TEXT, marginBottom: "1.5rem" }}>Envíanos un mensaje</h3>
                                <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                                    <input type="text" placeholder="Tu nombre" style={{ color: TEXT }} />
                                    <input type="tel" placeholder="Tu teléfono" style={{ color: TEXT }} />
                                    <input type="text" placeholder="¿En qué podemos ayudarte?" style={{ color: TEXT }} />
