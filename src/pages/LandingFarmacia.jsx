...
const DEFAULT_DATA = {
    ...
    descripcion: "Farmacia y botica con más de 15 años sirviendo a la comunidad. Ofrecemos medicamentos, productos de salud y asesoramiento profesional de calidad.",
    ciudad: "Santiago, Chile",
    telefono: "+56 2 2345 6789",
    email: "contacto@farmavida.cl",
    horario: "Lunes a domingo: 8:00 AM - 10:00 PM",
    anos_experiencia: "15+",
    clientes_atendidos: "50.000+",
    color_primario: "#0ea5a8",
    color_secundario: "#0d7a7d",
    font_titulo: "Poppins",
    font_cuerpo: "Inter",
    hero_variant: "centered",
    servicios_variant: "grid",
    nosotros_variant: "image",
    imagen_hero: "https://images.unsplash.com/photo-1587854692152-cbe660dbde0b?w=1800&q=80",
    imagen_nosotros: "https://images.unsplash.com/photo-1631217174073-ca57f2cf9d15?w=800&q=80",
    servicios: [
        { titulo: "Farmacia Completa", descripcion: "Medicamentos recetados y de venta libre, suplementos y vitaminas de calidad certificada.", icon: "pill" },
        { titulo: "Asesoramiento Farmacéutico", descripcion: "Consultas con profesionales capacitados para orientarte en el uso correcto de medicamentos.", icon: "stethoscope" },
        { titulo: "Productos de Belleza y Cuidado", descripcion: "Línea completa de cosméticos y productos de higiene personal de marcas reconocidas.", icon: "heart" },
        { titulo: "Entregas a Domicilio", descripcion: "Servicio rápido y seguro de entrega a domicilio en toda la región metropolitana.", icon: "truck" },
    ],
    testimonios: [
        { nombre: "María García", cargo: "Cliente habitual", texto: "Excelente atención del equipo farmacéutico. Siempre encuentro lo que busco y los precios son muy competitivos." },
        { nombre: "Carlos López", cargo: "Paciente diabético", texto: "El asesoramiento profesional que recibo aquí es invaluable. Me siento seguro y bien orientado en mi tratamiento." },
        { nombre: "Daniela Muñoz", cargo: "Madre de familia", texto: "La entrega a domicilio es súper conveniente. Excelente servicio al cliente, muy recomendado." },
    ],
};

// SVG Icons
const Icons = {
    pill: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.5 2v19M10.5 2a4.5 4.5 0 0 1 4.5 4.5v10a4.5 4.5 0 0 1-4.5 4.5M10.5 2a4.5 4.5 0 0 0-4.5 4.5v10a4.5 4.5 0 0 0 4.5 4.5" /></svg>),
    stethoscope: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4.6 4.6A9 9 0 1 0 21 14.5a9 9 0 0 0-6.4-9.9M9 12a3 3 0 1 0 6 0 3 3 0 0 0-6 0" /></svg>),
    ...
    truck: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="6" width="22" height="12" rx="2" /><path d="M1 12h22M7 18v3M17 18v3" /></svg>),
...
function HeroCentered({ d, primary, primaryRgb, fontTitulo, scrollTo }) {
    return (
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
            <div style={{ position: "absolute", inset: 0, backgroundImage: `url('${d.imagen_hero || 'https://images.unsplash.com/photo-1587854692152-cbe660dbde0b?w=1800&q=80'}')`, backgroundSize: "cover", backgroundPosition: "center", filter: "brightness(0.4)" }} />
            <div style={{ position: "absolute", inset: 0, background: `linear-gradient(135deg, rgba(15,23,42,0.85) 0%, rgba(${primaryRgb},0.15) 100%)` }} />
            ...
            <div style={{ position: "relative", textAlign: "center", padding: "0 1.5rem", maxWidth: 780, zIndex: 1 }}>
                ...
                <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
                    <button className="btn-primary" style={{ padding: "1rem 2.5rem", fontSize: "1rem", borderRadius: "8px" }} onClick={() => scrollTo("contacto")}>Contáctanos</button>
        ...
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr", overflow: "hidden" }}>
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "8rem 3rem 4rem 4rem", background: "#0f172a", zIndex: 1 }}>
                ...
                <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
                    <button className="btn-primary" style={{ padding: "1rem 2rem", fontSize: "0.95rem", borderRadius: "8px" }} onClick={() => scrollTo("contacto")}>Contáctanos</button>
            ...
            <div style={{ position: "relative", overflow: "hidden" }}>
                <div style={{ position: "absolute", inset: 0, backgroundImage: `url('${d.imagen_hero || 'https://images.unsplash.com/photo-1587854692152-cbe660dbde0b?w=1800&q=80'}')`, backgroundSize: "cover", backgroundPosition: "center" }} />
                    ...
                    <div className="service-card">
                        ...
                        <div style={{ padding: "2rem", display: "flex", gap: "1.5rem", alignItems: "flex-start" }}>
                            <div style={{ width: 52, height: 52, minWidth: 52, background: `rgba(${primaryRgb},0.12)`, border: `1px solid rgba(${primaryRgb},0.3)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, borderRadius: "8px" }}>
                                <span style={{ width: 24, height: 24 }}>{Icons[s.icon] || Icons.pill}</span>
                            </div>
                            <div>
                ...
                <AnimatedSection key={i} delay={i * 80}>
                    <div style={{ display: "flex", alignItems: "center", gap: "2rem", padding: "1.75rem 2rem", background: "var(--bg3)", border: "1px solid var(--border)", borderLeft: `4px solid ${primary}`, transition: "all 0.3s", borderRadius: "8px" }}
                        ...
                        <div style={{ width: 40, height: 40, minWidth: 40, color: primary }}>
                            <span style={{ width: 28, height: 28, display: "block" }}>{Icons[s.icon] || Icons.pill}</span>
                        </div>
                        <div>
                    ...
                    <div className="service-card" style={{ height: "100%" }}>
                        ...
                        <div style={{ padding: "3rem 2.5rem" }}>
                            <div style={{ width: 64, height: 64, background: `rgba(${primaryRgb},0.15)`, border: `1px solid rgba(${primaryRgb},0.4)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, marginBottom: "1.5rem", borderRadius: "8px" }}>
                                <span style={{ width: 32, height: 32 }}>{Icons[featured.icon] || Icons.pill}</span>
                            </div>
                        ...
                        <div className="service-card">
                            ...
                            <div style={{ padding: "1.5rem", display: "flex", gap: "1rem", alignItems: "flex-start" }}>
                                <div style={{ width: 40, height: 40, minWidth: 40, background: `rgba(${primaryRgb},0.1)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, borderRadius: "6px" }}>
                                    <span style={{ width: 20, height: 20 }}>{Icons[s.icon] || Icons.pill}</span>
                                </div>
                                <div>
...
function NosotrosImage({ d }) {
    return (
        <div style={{ position: "relative", borderRadius: "12px", overflow: "hidden", aspectRatio: "4/3" }}>
            <img
                src={d.imagen_nosotros || 'https://images.unsplash.com/photo-1631217174073-ca57f2cf9d15?w=800&q=80'}
                alt="Nuestro equipo"
