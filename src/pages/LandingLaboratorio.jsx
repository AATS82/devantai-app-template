...
// ============================================================
// DEVANTAI — LANDING TEMPLATE: LABORATORIO
// Variantes dinámicas: hero_variant, servicios_variant, nosotros_variant
// Perfil: profesional_salud | Tema: dark/light
// ============================================================
...
const DEFAULT_DATA = {
    ...
    imagen_hero: "https://images.unsplash.com/photo-1576091160550-112173f7f869?w=1800&q=80",
    imagen_nosotros: "https://images.unsplash.com/photo-1631217314831-c02b6b2f0222?w=800&q=80",
    servicios: [
        { titulo: "{{SERVICIO_1}}", descripcion: "{{DESC_1}}", icon: "microscope" },
        { titulo: "{{SERVICIO_2}}", descripcion: "{{DESC_2}}", icon: "blood" },
        { titulo: "{{SERVICIO_3}}", descripcion: "{{DESC_3}}", icon: "heart" },
        { titulo: "{{SERVICIO_4}}", descripcion: "{{DESC_4}}", icon: "shield" },
    ],
    testimonios: [
...
// SVG Icons para laboratorio
const Icons = {
    microscope: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 4h12v7H6z"/><path d="M9 11v3M15 11v3"/><circle cx="12" cy="17" r="3"/><path d="M12 20v2"/><path d="M10 22h4"/></svg>),
    blood: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2c-1.1 0-2 .9-2 2v5c0 1.1.9 2 2 2s2-.9 2-2V4c0-1.1-.9-2-2-2z"/><path d="M8 9c-1.1 0-2 .9-2 2v6c0 2.2 1.8 4 4 4s4-1.8 4-4v-6c0-1.1-.9-2-2-2"/><path d="M12 21v1M8 22h8"/></svg>),
...
function HeroCentered({ d, primary, primaryRgb, fontTitulo, fontCuerpo, scrollTo, isDark, BG, BG2, TEXT, MUTED, BORDER }) {
    return (
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", background: BG }}>
            <div style={{ position: "absolute", inset: 0, backgroundImage: `url('${d.imagen_hero || 'https://images.unsplash.com/photo-1576091160550-112173f7f869?w=1800&q=80'}')`, backgroundSize: "cover", backgroundPosition: "center", filter: isDark ? "brightness(0.25)" : "brightness(0.95)" }} />
            <div style={{ position: "absolute", inset: 0, background: isDark ? `linear-gradient(135deg, rgba(15,23,42,0.9) 0%, rgba(${primaryRgb},0.1) 100%)` : `linear-gradient(135deg, rgba(255,255,255,0.85) 0%, rgba(${primaryRgb},0.05) 100%)` }} />
            ...
            <div style={{ position: "relative", textAlign: "center", padding: "0 1.5rem", maxWidth: 780, zIndex: 1 }}>
                <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: `rgba(${primaryRgb},0.15)`, border: `1px solid rgba(${primaryRgb},0.4)`, padding: "0.5rem 1.25rem", borderRadius: "20px", marginBottom: "1.5rem", fontFamily: `'${fontTitulo}', serif`, fontWeight: 600, fontSize: "0.8rem", letterSpacing: "0.15em", textTransform: "uppercase", color: primary }}>
                    ✓ {d.anos_experiencia} años de trayectoria
                </div>
                <h1 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "clamp(3rem, 8vw, 5.5rem)", fontWeight: 700, lineHeight: 1.0, letterSpacing: "-0.01em", marginBottom: "1.25rem", textTransform: "uppercase", color: TEXT }}>{d.nombre}</h1>
                <p style={{ fontSize: "clamp(1rem, 2.5vw, 1.25rem)", color: MUTED, maxWidth: 580, margin: "0 auto 2.5rem", lineHeight: 1.7 }}>{d.slogan || d.descripcion}</p>
                <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
                    <button className="btn-primary" style={{ padding: "1rem 2.5rem", fontSize: "1rem", borderRadius: "8px" }} onClick={() => scrollTo("contacto")}>Solicitar Análisis</button>
    ...
    return (
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr", overflow: "hidden" }}>
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "8rem 3rem 4rem 4rem", background: BG, zIndex: 1 }}>
                ...
                <h1 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "clamp(2.5rem, 5vw, 4.5rem)", fontWeight: 700, lineHeight: 1.0, letterSpacing: "-0.01em", marginBottom: "1.25rem", textTransform: "uppercase", color: TEXT }}>{d.nombre}</h1>
                <p style={{ fontSize: "1.1rem", color: MUTED, marginBottom: "2.5rem", lineHeight: 1.7, maxWidth: 420 }}>{d.slogan || d.descripcion}</p>
                <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
                    <button className="btn-primary" style={{ padding: "1rem 2rem", fontSize: "0.95rem", borderRadius: "8px" }} onClick={() => scrollTo("contacto")}>Solicitar Análisis</button>
            ...
            <div style={{ position: "relative", overflow: "hidden" }}>
                <div style={{ position: "absolute", inset: 0, backgroundImage: `url('${d.imagen_hero || 'https://images.unsplash.com/photo-1576091160550-112173f7f869?w=1800&q=80'}')`, backgroundSize: "cover", backgroundPosition: "center" }} />
        ...
        <div className="grid-2" style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: "2rem" }}>
            {(d.servicios || []).map((s, i) => (
                <AnimatedSection key={i} delay={i * 100}>
                    <div className="service-card" style={{ background: BG2, border: `1px solid ${BORDER}`, borderRadius: "12px", overflow: "hidden", transition: "all 0.3s", padding: "2.5rem" }}>
                        <div style={{ width: 56, height: 56, borderRadius: "50%", background: `rgba(${primaryRgb},0.12)`, border: `1px solid rgba(${primaryRgb},0.3)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, marginBottom: "1.5rem" }}>
                            <span style={{ width: 28, height: 28 }}>{Icons[s.icon] || Icons.microscope}</span>
                        </div>
                        <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1.35rem", fontWeight: 600, marginBottom: "0.75rem", color: TEXT }}>{s.titulo}</h3>
            ...
            {(d.servicios || []).map((s, i) => (
                <AnimatedSection key={i} delay={i * 80}>
                    <div style={{ display: "flex", alignItems: "center", gap: "2rem", padding: "2rem", background: BG2, border: `1px solid ${BORDER}`, borderLeft: `4px solid ${primary}`, borderRadius: "12px", transition: "all 0.3s" }}
                        ...
                        <div style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "2.8rem", fontWeight: 700, color: `rgba(${primaryRgb},0.25)`, minWidth: 60, lineHeight: 1 }}>
                            {String(i + 1).padStart(2, "0")}
                        </div>
                        <div style={{ width: 48, height: 48, minWidth: 48, borderRadius: "50%", background: `rgba(${primaryRgb},0.1)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary }}>
                            <span style={{ width: 28, height: 28, display: "block" }}>{Icons[s.icon] || Icons.microscope}</span>
                        </div>
                        <div>
                            <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1.2rem", fontWeight: 600, marginBottom: "0.3rem", color: TEXT }}>{s.titulo}</h3>
...
function ServiciosFeatured({ d, primary, primaryRgb, fontTitulo, fontCuerpo, isDark, BG, BG2, TEXT, MUTED, BORDER }) {
    ...
    return (
        <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: "2rem" }} className="grid-2">
            {featured && (
                <AnimatedSection>
                    <div style={{ background: BG2, border: `1px solid ${BORDER}`, borderRadius: "12px", overflow: "hidden", height: "100%", padding: "3rem" }}>
                        <div style={{ width: 72, height: 72, borderRadius: "50%", background: `rgba(${primaryRgb},0.15)`, border: `1px solid rgba(${primaryRgb},0.4)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, marginBottom: "1.5rem" }}>
                            <span style={{ width: 36, height: 36 }}>{Icons[featured.icon] || Icons.microscope}</span>
                        </div>
                        <div style={{ fontSize: "0.7rem", fontFamily: `'${fontTitulo}', serif`, letterSpacing: "0.2em", textTransform: "uppercase", color: primary, marginBottom: "1rem", fontWeight: 600 }}>Análisis principal</div>
                        <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "2rem", fontWeight: 700, textTransform: "none", lineHeight: 1.2, marginBottom: "1rem", color: TEXT }}>{featured.titulo}</h3>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                {rest.map((s, i) => (
                    <AnimatedSection key={i} delay={i * 100}>
                        <div style={{ background: BG2, border: `1px solid ${BORDER}`, borderRadius: "12px", overflow: "hidden", padding: "2rem", transition: "all 0.3s" }}
                            onMouseOver={e => e.currentTarget.style.borderColor = primary}
                            onMouseOut={e => e.currentTarget.style.borderColor = BORDER}>
                            <div style={{ display: "flex", gap: "1rem", alignItems: "flex-start" }}>
                                <div style={{ width: 48, height: 48, minWidth: 48, borderRadius: "50%", background: `rgba(${primaryRgb},0.1)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary }}>
                                    <span style={{ width: 24, height: 24 }}>{Icons[s.icon] || Icons.microscope}</span>
                                </div>
                                <div>
                                    <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1.1rem", fontWeight: 600, marginBottom: "0.3rem", color: TEXT }}>{s.titulo}</h3>
...
function NosotrosImage({ d, isDark, BG, BG2, TEXT, MUTED, BORDER }) {
    return (
        <div style={{ position: "relative", borderRadius: "12px", overflow: "hidden", aspectRatio: "4/3", border: `1px solid ${BORDER}` }}>
            <img
                src={d.imagen_nosotros || 'https://images.unsplash.com/photo-1631217314831-c02b6b2f0222?w=800&q=80'}
...
function NosotrosStats({ d, primary, primaryRgb, fontTitulo, fontCuerpo, isDark, BG, BG2, TEXT, MUTED, BORDER }) {
    return (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
            {[
                { n: d.anos_experiencia, l: "Años de trayectoria" },
                { n: d.clientes_atendidos, l: "Pacientes atendidos" },
                { n: "99%", l: "Precisión analítica" },
                { n: "2-4h", l: "Entrega de resultados" },
            ].map((s, i) => (
...
export default function LandingLaboratorio({ data, onEnter }) {
    ...
    const iniciales = (d.nombre || "LAB").split(" ").slice(0, 2).map(w => w[0]).join("").toUpperCase();
        ...
        <div style={{ fontFamily: `'${fontCuerpo}', sans-serif`, background: BG, color: TEXT, overflowX: "hidden" }}>
            <style>{`
                ...
                * { margin: 0; padding: 0; box-sizing: border-box; }
                ...
                .btn-primary { background: var(--primary); color: #fff; border: none; cursor: pointer; font-family: '${fontTitulo}', serif; font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase; transition: all 0.2s; }
                .btn-primary:hover { background: var(--primary-dark); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(${primaryRgb},0.35); }
                .btn-outline { background: transparent; color: var(--primary); border: 1.5px solid var(--primary); cursor: pointer; font-family: '${fontTitulo}', serif; font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase; transition: all 0.2s; }
                .btn-outline:hover { background: rgba(${primaryRgb},0.1); }
                .service-card:hover { border-color: var(--primary); transform: translateY(-4px); box-shadow: 0 16px 40px rgba(0,0,0,0.15); }
                ...
                input, textarea { background: var(--bg2); border: 1px solid var(--border); color: var(--text); font-family: '${fontCuerpo}', sans-serif; font-size: 0.95rem; padding: 0.85rem 1rem; width: 100%; outline: none; border-radius: 8px; transition: border-color 0.2s; }
            ...
            <nav style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", cursor: "pointer" }} onClick={() => scrollTo("inicio")}>
                    ...
                    <span style={{ fontFamily: `'${fontTitulo}', serif`, fontWeight: 600, fontSize: "1.1rem", letterSpacing: "0.05em", color: TEXT }}>{d.nombre}</span>
                </div>
                <div className="desktop-nav" style={{ display: "flex", alignItems: "center", gap: "2.5rem" }}>
                    ...
                    <button className="btn-primary" style={{ padding: "0.6rem 1.4rem", fontSize: "0.85rem", borderRadius: "8px" }} onClick={() => scrollTo("contacto")}>Agendar</button>
                </div>
            ...
            {menuOpen && (
                <div style={{ position: "fixed", top: 65, left: 0, right: 0, zIndex: 999, background: isDark ? 'rgba(15,23,42,0.98)' : 'rgba(255,255,255,0.98)', borderBottom: `1px solid ${BORDER}`, padding: "1.5rem 2rem", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                    ...
                    <button className="btn-primary" style={{ padding: "0.8rem", fontSize: "0.9rem", borderRadius: "8px" }} onClick={() => scrollTo("contacto")}>Agendar</button>
                </div>
            )}
            ...
            <section style={{ background: primary, padding: "2.5rem 2rem", color: "#fff" }}>
                <div className="stats-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", maxWidth: 900, margin: "0 auto", textAlign: "center", gap: "1rem" }}>
                    {[
                        ...
                        <div key={i}>
                            <div style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "2.2rem", fontWeight: 700, letterSpacing: "-0.02em" }}>{s.n}</div>
            ...
            <section id="servicios" style={{ background: BG2, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <p style={{ textAlign: "center", fontFamily: `'${fontTitulo}', serif`, fontWeight: 600, fontSize: "0.8rem", letterSpacing: "0.2em", textTransform: "uppercase", color: primary, marginBottom: "0.5rem" }}>Servicios</p>
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 700, textTransform: "none", letterSpacing: "-0.01em", marginBottom: "3.5rem", color: TEXT }}>Nuestros Análisis Clínicos</h2>
                    </AnimatedSection>
                    {(() => {
            ...
            <section id="nosotros" style={{ background: BG, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }} className="grid-2">
                    <AnimatedSection>
                        <div className="divider"><div className="divider-line" /><div className="divider-dot" /><div className="divider-line" /></div>
                        <p style={{ fontFamily: `'${fontTitulo}', serif`, fontWeight: 600, fontSize: "0.8rem", letterSpacing: "0.2em", textTransform: "uppercase", color: primary, marginBottom: "0.5rem" }}>Quiénes somos</p>
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "clamp(2rem,4vw,2.8rem)", fontWeight: 700, textTransform: "none", lineHeight: 1.2, marginBottom: "1.5rem", color: TEXT }}>Laboratorio de confianza y precisión</h2>
                        <p style={{ color: MUTED, lineHeight: 1.7, marginBottom: "2rem" }}>{d.descripcion}</p>
                        <button className="btn-primary" style={{ padding: "0.9rem 2rem", fontSize: "0.9rem", borderRadius: "8px" }} onClick={() => scrollTo("contacto")}>Agendar análisis</button>
                    </AnimatedSection>
                    <AnimatedSection delay={150}>
                        {(() => {
                            const props = { d, isDark, BG, BG2, TEXT, MUTED, BORDER, primary, primaryRgb, fontTitulo, fontCuerpo };
            ...
            <section id="testimonios" style={{ background: BG2, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <AnimatedSection>
                        <div className="divider"><div className="divider-line" /><div className="divider-dot" /><div className="divider-line" /></div>
                        <p style={{ textAlign: "center", fontFamily: `'${fontTitulo}', serif`, fontWeight: 600, fontSize: "0.8rem", letterSpacing: "0.2em", textTransform: "uppercase", color: primary, marginBottom: "0.5rem" }}>Testimonios</p>
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 700, textTransform: "none", marginBottom: "3.5rem", color: TEXT }}>Lo que dicen nuestros pacientes</h2>
                    </AnimatedSection>
                            ...
                            <AnimatedSection key={i} delay={i * 120}>
                                <div className="testim-card">
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                                        <div style={{ width: 40, height: 40, background: primary, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', serif`, fontWeight: 700, fontSize: "1rem", borderRadius: "50%", color: "#fff" }}>
            ...
            <section id="contacto" style={{ background: BG, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 700, textTransform: "none", marginBottom: "3.5rem", color: TEXT }}>¿Necesitas agendar un análisis?</h2>
                    </AnimatedSection>
                    <div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: "4rem", alignItems: "start" }}>
                        <AnimatedSection>
                            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                                {[
                                    ...
                                    <div key={i} style={{ display: "flex", gap: "1rem", alignItems: "flex-start", padding: "1.5rem", background: BG2, border: `1px solid ${BORDER}`, borderRadius: "12px" }}>
                                        <div style={{ width: 48, height: 48, minWidth: 48, borderRadius: "50%", background: `rgba(${primaryRgb},0.12)`, border: `1px solid rgba(${primaryRgb},0.3)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary }}>
                                ...
                                <a href={waLink} target="_blank" rel="noopener noreferrer"
                                    style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.75rem", background: "#25d366", color: "#fff", padding: "1rem", fontFamily: `'${fontTitulo}', serif`, fontWeight: 600, letterSpacing: "0.05em", textTransform: "uppercase", fontSize: "1rem", transition: "background 0.2s", borderRadius: "8px" }}
                        ...
                        <AnimatedSection delay={150}>
                            <div style={{ background: BG2, border: `1px solid ${BORDER}`, borderRadius: "12px", padding: "3rem" }}>
                                <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1.4rem", fontWeight: 600, textTransform: "none", marginBottom: "2rem", color: TEXT }}>Envía tu consulta</h3>
                                <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                                    ...
                                    <input type="text" placeholder="¿Qué análisis necesitas?" style={{ borderRadius: "8px" }} />
                                    <textarea placeholder="Cuéntanos más..." style={{ borderRadius: "8px" }} />
                                    <button className="btn-primary" style={{ padding: "1rem", fontSize: "1rem", borderRadius: "8px", width: "100%" }}>Enviar solicitud</button>
                                </div>
                            </div>
                        </AnimatedSection>
                    </div>
            ...
            <footer style={{ background: isDark ? '#080809' : '#f0f4f8', borderTop: `1px solid ${BORDER}`, padding: "3rem 2rem 1.5rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "2rem", paddingBottom: "2rem", borderBottom: `1px solid ${BORDER}`, marginBottom: "1.5rem" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                            <div style={{ width: 36, height: 36, background: primary, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', serif`, fontWeight: 700, borderRadius: "8px", color: "#fff" }}>{iniciales}</div>
                            <span style={{ fontFamily: `'${fontTitulo}', serif`, fontWeight: 600, fontSize: "1rem", color: TEXT }}>{d.nombre}</span>
                        </div>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
                        ...
                        <p style={{ color: MUTED, fontSize: "0.75rem", letterSpacing: "0.05em", opacity: 0.7 }}>Powered by Devantai</p>
                    </div>
                </div>
            </footer>
