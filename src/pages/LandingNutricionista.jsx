...
// ============================================================
// DEVANTAI — LANDING TEMPLATE: NUTRICIONISTA
...
const DEFAULT_DATA = {
    ...
    imagen_nosotros: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80",
    color_primario: "#c17a5a",
    color_secundario: "#d4a574",
    font_titulo: "Playfair Display",
    font_cuerpo: "Source Sans Pro",
    servicios: [
        { titulo: "{{SERVICIO_1}}", descripcion: "{{DESC_1}}", icon: "apple" },
        { titulo: "{{SERVICIO_2}}", descripcion: "{{DESC_2}}", icon: "scale" },
...
// SVG Icons
const Icons = {
    apple: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="1" /><path d="M7 20c-1.6-1.7-2.7-4-2.7-6.5 0-5.1 4.1-9.5 9.2-9.5 1.9 0 3.7.6 5.2 1.6" /><path d="M16.4 3.8c1.5 1.1 2.6 2.8 2.6 4.7 0 .9-.2 1.8-.5 2.6" /></svg>),
    scale: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3v18M6 9h12M8 6h8M6 15h12M8 12h8" /></svg>),
...
function HeroCentered({ d, primary, primaryRgb, fontTitulo, scrollTo, isDark, BG, BG2, TEXT, MUTED, BORDER }) {
    return (
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", background: BG }}>
            <div style={{ position: "absolute", inset: 0, backgroundImage: `url('${d.imagen_hero}')`, backgroundSize: "cover", backgroundPosition: "center", filter: `brightness(${isDark ? 0.35 : 0.25})` }} />
            ...
            <div style={{ position: "relative", textAlign: "center", padding: "0 1.5rem", maxWidth: 780, zIndex: 1 }}>
                ...
                <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
                    <button className="btn-primary" style={{ padding: "1rem 2.5rem", fontSize: "1rem", borderRadius: "20px" }} onClick={() => scrollTo("contacto")}>Solicitar Consulta</button>
    ...
    return (
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr", overflow: "hidden", background: BG }}>
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "8rem 3rem 4rem 4rem", background: BG, zIndex: 1 }}>
                ...
                <h1 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "clamp(2.5rem, 5vw, 4.5rem)", fontWeight: 700, lineHeight: 1.0, letterSpacing: "-0.01em", marginBottom: "1.25rem", textTransform: "uppercase", color: TEXT }}>{d.nombre}</h1>
                <p style={{ fontSize: "1.1rem", color: MUTED, marginBottom: "2.5rem", lineHeight: 1.7, maxWidth: 420 }}>{d.slogan || d.descripcion}</p>
                <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
                    <button className="btn-primary" style={{ padding: "1rem 2rem", fontSize: "0.95rem", borderRadius: "20px" }} onClick={() => scrollTo("contacto")}>Solicitar Consulta</button>
    ...
    return (
        <section id="inicio" style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: BG, borderBottom: `3px solid ${primary}`, overflow: "hidden" }}>
            <div style={{ textAlign: "center", padding: "0 1.5rem", maxWidth: 900 }}>
                ...
                <h1 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "clamp(3.5rem, 10vw, 7rem)", fontWeight: 700, lineHeight: 0.95, letterSpacing: "-0.03em", textTransform: "uppercase", marginBottom: "2rem", color: TEXT }}>
                    {d.nombre}
                </h1>
                <div style={{ width: 60, height: 4, background: primary, margin: "0 auto 2rem", borderRadius: "2px" }} />
        ...
        <div className="grid-2" style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: "1.5rem" }}>
            {(d.servicios || []).map((s, i) => (
                <AnimatedSection key={i} delay={i * 100}>
                    <div className="service-card" style={{ background: isDark ? BG2 : `rgba(${primaryRgb},0.05)`, border: `1px solid ${BORDER}`, borderRadius: "20px" }}>
                        <div className="card-accent" />
                        <div style={{ padding: "2rem", display: "flex", gap: "1.5rem", alignItems: "flex-start" }}>
                            <div style={{ width: 52, height: 52, minWidth: 52, background: isDark ? `rgba(${primaryRgb},0.15)` : `rgba(${primaryRgb},0.2)`, border: `1.5px solid rgba(${primaryRgb},0.4)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, borderRadius: "16px" }}>
                                <span style={{ width: 24, height: 24 }}>{Icons[s.icon] || Icons.apple}</span>
                            </div>
                            <div>
                                <h3 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "1.3rem", fontWeight: 600, textTransform: "capitalize", letterSpacing: "0.02em", marginBottom: "0.5rem", color: TEXT }}>{s.titulo}</h3>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {(d.servicios || []).map((s, i) => (
                <AnimatedSection key={i} delay={i * 80}>
                    <div style={{ display: "flex", alignItems: "center", gap: "2rem", padding: "1.75rem 2rem", background: isDark ? BG2 : `rgba(${primaryRgb},0.05)`, border: `1px solid ${BORDER}`, borderLeft: `4px solid ${primary}`, transition: "all 0.3s", borderRadius: "16px" }}
                        onMouseOver={e => e.currentTarget.style.background = isDark ? `rgba(${primaryRgb},0.1)` : `rgba(${primaryRgb},0.1)`}
                        onMouseOut={e => e.currentTarget.style.background = isDark ? BG2 : `rgba(${primaryRgb},0.05)`}>
                        <div style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "3rem", fontWeight: 700, color: isDark ? `rgba(${primaryRgb},0.25)` : `rgba(${primaryRgb},0.15)`, minWidth: 60, lineHeight: 1 }}>
                            {String(i + 1).padStart(2, "0")}
                        </div>
                        <div style={{ width: 40, height: 40, minWidth: 40, color: primary }}>
                            <span style={{ width: 28, height: 28, display: "block" }}>{Icons[s.icon] || Icons.apple}</span>
                        </div>
                        <div>
                            <h3 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "1.2rem", fontWeight: 600, textTransform: "capitalize", letterSpacing: "0.02em", marginBottom: "0.3rem", color: TEXT }}>{s.titulo}</h3>
...
function ServiciosFeatured({ d, primary, primaryRgb, fontTitulo, isDark, BG, BG2, TEXT, MUTED, BORDER }) {
    ...
    return (
        <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: "1.5rem" }} className="grid-2">
            {featured && (
                <AnimatedSection>
                    <div className="service-card" style={{ height: "100%", background: isDark ? BG2 : `rgba(${primaryRgb},0.08)`, border: `1px solid ${BORDER}`, borderRadius: "20px" }}>
                        <div className="card-accent" style={{ width: "100%" }} />
                        <div style={{ padding: "3rem 2.5rem" }}>
                            <div style={{ width: 64, height: 64, background: isDark ? `rgba(${primaryRgb},0.15)` : `rgba(${primaryRgb},0.2)`, border: `1.5px solid rgba(${primaryRgb},0.4)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, marginBottom: "1.5rem", borderRadius: "16px" }}>
                                <span style={{ width: 32, height: 32 }}>{Icons[featured.icon] || Icons.apple}</span>
                            </div>
                            ...
                            <h3 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "2rem", fontWeight: 700, textTransform: "capitalize", lineHeight: 1.1, marginBottom: "1rem", color: TEXT }}>{featured.titulo}</h3>
                    ...
                    <AnimatedSection key={i} delay={i * 100}>
                        <div className="service-card" style={{ background: isDark ? BG2 : `rgba(${primaryRgb},0.05)`, border: `1px solid ${BORDER}`, borderRadius: "20px" }}>
                            ...
                            <div style={{ padding: "1.5rem", display: "flex", gap: "1rem", alignItems: "flex-start" }}>
                                <div style={{ width: 40, height: 40, minWidth: 40, background: isDark ? `rgba(${primaryRgb},0.15)` : `rgba(${primaryRgb},0.2)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, borderRadius: "12px" }}>
                                    <span style={{ width: 20, height: 20 }}>{Icons[s.icon] || Icons.apple}</span>
                                </div>
                                <div>
                                    <h3 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "1rem", fontWeight: 600, textTransform: "capitalize", marginBottom: "0.3rem", color: TEXT }}>{s.titulo}</h3>
    ...
    return (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
            {[
                ...
                <div key={i} style={{ padding: "2rem", background: isDark ? BG2 : `rgba(${primary.substring(1)},0.05)`, border: `1px solid ${BORDER}`, borderTop: `4px solid ${primary}`, borderRadius: "16px" }}>
...
export default function LandingNutricionista({ data, onEnter }) {
    ...
    const primary = d.color_primario || '#c17a5a';
        ...
        <div style={{ fontFamily: `'${fontCuerpo}', sans-serif`, background: BG, color: TEXT, overflowX: "hidden" }}>
            <style>{`
                ...
                * { margin: 0; padding: 0; box-sizing: border-box; }
                ...
                .btn-primary { background: var(--primary); color: #fff; border: none; cursor: pointer; font-family: '${fontTitulo}', sans-serif; font-weight: 600; letter-spacing: 0.08em; text-transform: uppercase; transition: all 0.2s; }
                .btn-primary:hover { background: var(--primary-dark); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(${primaryRgb},0.3); }
                .btn-outline { background: transparent; color: var(--primary); border: 1.5px solid var(--primary); cursor: pointer; font-family: '${fontTitulo}', sans-serif; font-weight: 600; letter-spacing: 0.08em; text-transform: uppercase; transition: all 0.2s; }
                .btn-outline:hover { background: rgba(${primaryRgb},0.1); }
                .service-card { transition: all 0.3s; }
                .service-card:hover { transform: translateY(-4px); box-shadow: 0 16px 40px rgba(0,0,0,${isDark ? 0.2 : 0.08}); }
                ...
                input, textarea { background: var(--bg2); border: 1px solid var(--border); color: var(--text); font-family: '${fontCuerpo}', sans-serif; font-size: 0.95rem; padding: 0.85rem 1rem; width: 100%; outline: none; border-radius: 12px; transition: border-color 0.2s; }
            ...
            <nav style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", cursor: "pointer" }} onClick={() => scrollTo("inicio")}>
                    <div style={{ width: 40, height: 40, background: primary, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 700, fontSize: "1rem", letterSpacing: "0.05em", color: "#fff", borderRadius: "12px" }}>{iniciales}</div>
                    <span style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 600, fontSize: "1.1rem", letterSpacing: "0.05em", textTransform: "capitalize", color: TEXT }}>{d.nombre}</span>
                </div>
            ...
            <section style={{ background: primary, padding: "2.5rem 2rem" }}>
                <div className="stats-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", maxWidth: 900, margin: "0 auto", textAlign: "center", gap: "1rem" }}>
                    {[
                        ...
                        <div key={i}>
                            <div style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "2.2rem", fontWeight: 700, letterSpacing: "-0.02em", color: "#fff" }}>{s.n}</div>
            ...
            <section id="servicios" style={{ background: BG2, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', sans-serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 700, textTransform: "capitalize", letterSpacing: "-0.01em", marginBottom: "3.5rem", color: TEXT }}>Nuestros Servicios</h2>
                    </AnimatedSection>
                    {(() => {
            ...
            <section id="nosotros" style={{ background: BG, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }} className="grid-2">
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "clamp(2rem,4vw,2.8rem)", fontWeight: 700, textTransform: "capitalize", lineHeight: 1.1, marginBottom: "1.5rem", color: TEXT }}>Nutrición personalizada para tu salud</h2>
                        <p style={{ color: MUTED, lineHeight: 1.7, marginBottom: "2rem" }}>{d.descripcion}</p>
                        <button className="btn-primary" style={{ padding: "0.9rem 2rem", fontSize: "0.9rem", borderRadius: "12px" }} onClick={() => scrollTo("contacto")}>Agendar Consulta</button>
                    </AnimatedSection>
                    <AnimatedSection delay={150}>
                        {(() => {
                            const props = { d, isDark, BG, BG2, TEXT, MUTED, BORDER };
                            if (d.nosotros_variant === "stats") return <NosotrosStats {...props} primary={primary} fontTitulo={fontTitulo} />;
            ...
            <section id="testimonios" style={{ background: BG2, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', sans-serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 700, textTransform: "capitalize", marginBottom: "3.5rem", color: TEXT }}>Lo que dicen de nosotros</h2>
                    </AnimatedSection>
                        ...
                        {(d.testimonios || []).map((t, i) => (
                            <AnimatedSection key={i} delay={i * 120}>
                                <div className="testim-card">
                                    <div style={{ display: "flex", gap: "0.25rem", marginBottom: "1rem", color: "#d4a574" }}>
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                                        <div style={{ width: 40, height: 40, background: primary, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 700, fontSize: "1rem", color: "#fff", borderRadius: "10px" }}>
            ...
            <section id="contacto" style={{ background: BG, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', sans-serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 700, textTransform: "capitalize", marginBottom: "3.5rem", color: TEXT }}>Comienza tu transformación hoy</h2>
                    </AnimatedSection>
                    <div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: "4rem", alignItems: "start" }}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                                {[
                                    ...
                                    <div key={i} style={{ display: "flex", gap: "1rem", alignItems: "flex-start", padding: "1.25rem", background: BG2, border: `1px solid ${BORDER}`, borderRadius: "16px" }}>
                                        <div style={{ width: 42, height: 42, minWidth: 42, background: isDark ? `rgba(${primaryRgb},0.15)` : `rgba(${primaryRgb},0.2)`, border: `1.5px solid rgba(${primaryRgb},0.4)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, borderRadius: "12px" }}>
                                ...
                                <a href={waLink} target="_blank" rel="noopener noreferrer"
                                    style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.75rem", background: "#25d366", color: "#fff", padding: "1rem", fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", fontSize: "1rem", transition: "background 0.2s", borderRadius: "12px" }}
                        ...
                        <AnimatedSection delay={150}>
                            <div style={{ background: BG2, border: `1px solid ${BORDER}`, padding: "2.5rem", borderRadius: "20px" }}>
                                <h3 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "1.4rem", fontWeight: 600, textTransform: "capitalize", marginBottom: "1.5rem", color: TEXT }}>Envíanos un mensaje</h3>
                                <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            {/* ── FOOTER ── */}
            <footer style={{ background: isDark ? '#0a0f19' : '#f5f7fa', borderTop: `1px solid ${BORDER}`, padding: "3rem 2rem 1.5rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "2rem", paddingBottom: "2rem", borderBottom: `1px solid ${BORDER}`, marginBottom: "1.5rem" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                            <div style={{ width: 36, height: 36, background: primary, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 700, color: "#fff", borderRadius: "10px" }}>{iniciales}</div>
                            <span style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 600, fontSize: "1rem", textTransform: "capitalize", letterSpacing: "0.05em", color: TEXT }}>{d.nombre}</span>
                        </div>
            ...
            {onEnter && (
                <button onClick={onEnter} style={{
                    ...
                    fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 600,
