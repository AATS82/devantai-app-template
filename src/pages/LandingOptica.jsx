...
const DEFAULT_DATA = {
    nombre: "VisionCare Óptica",
    slogan: "Tu visión, nuestra prioridad",
    descripcion: "En VisionCare Óptica ofrecemos soluciones integrales para tu salud visual. Desde exámenes oftalmológicos hasta lentes de última tecnología, somos tu aliado de confianza.",
    ciudad: "Santiago, Chile",
    telefono: "+56 9 1234 5678",
    email: "contacto@visioncare.cl",
    horario: "Lun-Sab 09:00-19:00 / Dom 10:00-15:00",
    anos_experiencia: "15",
    ...
    imagen_hero: "https://images.unsplash.com/photo-1577722643272-265e434f5a1d?w=1800&q=80",
    imagen_nosotros: "https://images.unsplash.com/photo-1576091160550-112173f31c77?w=800&q=80",
    servicios: [
        { titulo: "Examen Visual Completo", descripcion: "Evaluación profesional de tu vista con tecnología moderna para detectar problemas refractivos.", icon: "eye" },
        { titulo: "Lentes Oftálmicos", descripcion: "Amplio catálogo de marcos y lentes para todas las edades con marcas de prestigio internacional.", icon: "glasses" },
        { titulo: "Lentes de Contacto", descripcion: "Asesoría experta en lentes de contacto con revisiones periódicas y productos de calidad.", icon: "lens" },
        { titulo: "Protección UV", descripcion: "Lentes solares con protección total contra radiación UV para cuidar tu salud ocular.", icon: "sun" },
    ],
    testimonios: [
        { nombre: "María González", cargo: "Ejecutiva", texto: "Excelente atención, me realizaron un completo examen visual y encontraron un problema que no sabía que tenía. Muy profesionales." },
        { nombre: "Carlos Rodríguez", cargo: "Ingeniero", texto: "Los lentes que me recomendaron son perfectos. La calidad es superior y el precio justo. Volvería mil veces más." },
        { nombre: "Ana Martínez", cargo: "Diseñadora", texto: "Me enamoré de los frames que elegí y la consulta con el especialista fue muy detallada. Recomendado 100%." },
    ],
};
...
const Icons = {
    ...
    glasses: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M23 1H1v6h6V1h6v6h6V1z"/><path d="M4 7a3 3 0 1 0 6 0 3 3 0 0 0-6 0z"/><path d="M14 7a3 3 0 1 0 6 0 3 3 0 0 0-6 0z"/><path d="M9 13h6"/></svg>),
    lens: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="5"/><circle cx="12" cy="12" r="2"/></svg>),
...
function HeroCentered({ d, primary, primaryRgb, fontTitulo, scrollTo }) {
    return (
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
            <div style={{ position: "absolute", inset: 0, backgroundImage: `url('${d.imagen_hero || 'https://images.unsplash.com/photo-1577722643272-265e434f5a1d?w=1800&q=80'}')`, backgroundSize: "cover", backgroundPosition: "center", filter: "brightness(0.4)" }} />
            <div style={{ position: "absolute", inset: 0, background: `linear-gradient(135deg, rgba(20,20,40,0.85) 0%, rgba(${primaryRgb},0.15) 100%)` }} />
            <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 120, background: "linear-gradient(to bottom right, transparent 49%, #0f1520 50%)" }} />
...
function HeroSplit({ d, primary, primaryRgb, fontTitulo, scrollTo }) {
    return (
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr", overflow: "hidden" }}>
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "8rem 3rem 4rem 4rem", background: "#0f1520", zIndex: 1 }}>
            ...
            <div style={{ position: "relative", overflow: "hidden" }}>
                <div style={{ position: "absolute", inset: 0, backgroundImage: `url('${d.imagen_hero || 'https://images.unsplash.com/photo-1577722643272-265e434f5a1d?w=1800&q=80'}')`, backgroundSize: "cover", backgroundPosition: "center" }} />
                <div style={{ position: "absolute", inset: 0, background: `linear-gradient(to right, #0f1520 0%, transparent 30%, rgba(${primaryRgb},0.2) 100%)` }} />
                <div style={{ position: "absolute", left: 0, top: 0, bottom: 0, width: 80, background: "linear-gradient(to right, #0f1520, transparent)" }} />
            </div>
        </section>
    );
}
...
function HeroMinimal({ d, primary, primaryRgb, fontTitulo, scrollTo }) {
    return (
        <section id="inicio" style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#0f1520", borderBottom: `3px solid ${primary}`, overflow: "hidden" }}>
                ...
                <AnimatedSection key={i} delay={i * 80}>
                    <div style={{ display: "flex", alignItems: "center", gap: "2rem", padding: "1.75rem 2rem", background: "var(--bg3)", border: "1px solid var(--border)", borderLeft: `4px solid ${primary}`, transition: "all 0.3s", borderRadius: "8px" }}
                        ...
                        <div style={{ width: 40, height: 40, minWidth: 40, color: primary }}>
                            <span style={{ width: 28, height: 28, display: "block" }}>{Icons[s.icon] || Icons.eye}</span>
                        </div>
                        <div>
                    ...
                    <div className="service-card" style={{ height: "100%" }}>
                        ...
                        <div style={{ padding: "3rem 2.5rem" }}>
                            <div style={{ width: 64, height: 64, background: `rgba(${primaryRgb},0.15)`, border: `1px solid rgba(${primaryRgb},0.4)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, marginBottom: "1.5rem", borderRadius: "8px" }}>
                                <span style={{ width: 32, height: 32 }}>{Icons[featured.icon] || Icons.eye}</span>
                            </div>
                        ...
                        <div className="service-card">
                            ...
                            <div style={{ padding: "1.5rem", display: "flex", gap: "1rem", alignItems: "flex-start" }}>
                                <div style={{ width: 40, height: 40, minWidth: 40, background: `rgba(${primaryRgb},0.1)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, borderRadius: "6px" }}>
                                    <span style={{ width: 20, height: 20 }}>{Icons[s.icon] || Icons.eye}</span>
                                </div>
                                <div>
...
export default function LandingOptica({ data, onEnter }) {
    ...
    const iniciales = (d.nombre || "VO").split(" ").slice(0, 2).map(w => w[0]).join("").toUpperCase();
    ...
    return (
        <div style={{ fontFamily: `'${fontCuerpo}', sans-serif`, background: "#0f1520", color: "#f0f0f0", overflowX: "hidden" }}>
            <style>{`
                ...
                * { margin: 0; padding: 0; box-sizing: border-box; }
                ...
                .testim-card:hover { border-color: rgba(0,102,204,0.4); }
            ...
            <nav style={{
                ...
                padding: "1rem 2rem",
                background: scrolled ? "rgba(15,21,32,0.97)" : "transparent",
            ...
            {menuOpen && (
                <div style={{ position: "fixed", top: 65, left: 0, right: 0, zIndex: 999, background: "rgba(15,21,32,0.98)", borderBottom: "1px solid var(--border)", padding: "1.5rem 2rem", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                    {["inicio", "servicios", "nosotros", "testimonios", "contacto"].map(s => (
            ...
            <section id="nosotros" style={{ background: "var(--bg)", padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }} className="grid-2">
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "clamp(2rem,4vw,2.8rem)", fontWeight: 800, textTransform: "uppercase", lineHeight: 1.1, marginBottom: "1.5rem" }}>Tu visión es nuestro compromiso</h2>
                        <p style={{ color: "var(--muted)", lineHeight: 1.7, marginBottom: "2rem" }}>{d.descripcion}</p>
                        <button className="btn-primary" style={{ padding: "0.9rem 2rem", fontSize: "0.9rem", borderRadius: "8px" }} onClick={() => scrollTo("contacto")}>Contáctanos hoy</button>
                    </AnimatedSection>
            ...
            <section id="contacto" style={{ background: "var(--bg)", padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', sans-serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 800, textTransform: "uppercase", marginBottom: "3.5rem" }}>Agenda tu cita hoy</h2>
                    </AnimatedSection>
                        ...
                        <AnimatedSection delay={150}>
                            <div style={{ background: "var(--bg3)", border: "1px solid var(--border)", padding: "2.5rem", borderRadius: "12px" }}>
                                ...
                                <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                                    ...
                                    <input type="text" placeholder="¿Qué tipo de lente necesitas?" />
            ...
            {/* ── FOOTER ── */}
            <footer style={{ background: "#0a1118", borderTop: "1px solid var(--border)", padding: "3rem 2rem 1.5rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
