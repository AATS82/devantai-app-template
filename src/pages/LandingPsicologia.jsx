...
// ============================================================
// DEVANTAI — LANDING TEMPLATE: PSICOLOGÍA
// Tema: light | Perfil: cálido_familiar
// ============================================================
...
const DEFAULT_DATA = {
    ...
    tema: "light",
    color_primario: "#a4793f",
    color_secundario: "#8b6f47",
    font_titulo: "Playfair Display",
    font_cuerpo: "Source Sans Pro",
    hero_variant: "centered",
    servicios_variant: "grid",
    nosotros_variant: "image",
    imagen_hero: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a9?w=1800&q=80",
    imagen_nosotros: "https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=800&q=80",
    servicios: [
        { titulo: "{{SERVICIO_1}}", descripcion: "{{DESC_1}}", icon: "heart" },
        { titulo: "{{SERVICIO_2}}", descripcion: "{{DESC_2}}", icon: "brain" },
        { titulo: "{{SERVICIO_3}}", descripcion: "{{DESC_3}}", icon: "users" },
        { titulo: "{{SERVICIO_4}}", descripcion: "{{DESC_4}}", icon: "smile" },
    ],
    testimonios: [
...
const Icons = {
    ...
    brain: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2c1.1 0 2 .9 2 2v1.5M12 2c-1.1 0-2 .9-2 2v1.5M9 7c-1.1 0-2 .9-2 2v1.5M15 7c1.1 0 2 .9 2 2v1.5M7 10c-1.1 0-2 .9-2 2v2c0 1.1.9 2 2 2h1M17 10c1.1 0 2 .9 2 2v2c0 1.1-.9 2-2 2h-1M6 16c0 1.5 1 2.8 2.5 3.4M18 16c0 1.5-1 2.8-2.5 3.4M12 19c1 0 2 .5 2 1.5M12 19c-1 0-2 .5-2 1.5" /></svg>),
...
function HeroCentered({ d, primary, primaryRgb, fontTitulo, scrollTo, BG, BG2, TEXT, MUTED, BORDER }) {
    return (
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", background: BG }}>
            ...
            <div style={{ position: "absolute", inset: 0, background: `linear-gradient(135deg, rgba(255,255,255,0.92) 0%, rgba(${primaryRgb},0.08) 100%)` }} />
            ...
            <div style={{ position: "relative", textAlign: "center", padding: "0 1.5rem", maxWidth: 780, zIndex: 1 }}>
                <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: `rgba(${primaryRgb},0.08)`, border: `2px solid ${primary}`, padding: "0.5rem 1.2rem", borderRadius: "24px", marginBottom: "1.5rem", fontFamily: `'${fontTitulo}', serif`, fontWeight: 600, fontSize: "0.85rem", letterSpacing: "0.08em", textTransform: "uppercase", color: primary }}>
                    ★ {d.anos_experiencia} años de experiencia ★
                </div>
                <h1 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "clamp(3rem, 8vw, 5.5rem)", fontWeight: 700, lineHeight: 1.0, letterSpacing: "-0.01em", marginBottom: "1.25rem", color: TEXT, textTransform: "capitalize" }}>{d.nombre}</h1>
                ...
                <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
                    <button className="btn-primary" style={{ padding: "1rem 2.5rem", fontSize: "1rem", borderRadius: "16px" }} onClick={() => scrollTo("contacto")}>Agendar Consulta</button>
                    <button className="btn-outline" style={{ padding: "1rem 2.5rem", fontSize: "1rem", borderRadius: "16px" }} onClick={() => scrollTo("servicios")}>Conocer Servicios</button>
                </div>
            </div>
        </section>
    );
    ...
    return (
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr", overflow: "hidden", background: BG }}>
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "8rem 3rem 4rem 4rem", background: BG, zIndex: 1 }}>
                <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: `rgba(${primaryRgb},0.1)`, border: `2px solid ${primary}`, padding: "0.5rem 1.2rem", borderRadius: "24px", marginBottom: "1.5rem", fontFamily: `'${fontTitulo}', serif`, fontWeight: 600, fontSize: "0.75rem", letterSpacing: "0.08em", textTransform: "uppercase", color: primary, width: "fit-content" }}>
                    ★ {d.anos_experiencia} años de experiencia ★
                </div>
                <h1 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "clamp(2.5rem, 5vw, 4.5rem)", fontWeight: 700, lineHeight: 1.0, letterSpacing: "-0.01em", marginBottom: "1.25rem", color: TEXT, textTransform: "capitalize" }}>{d.nombre}</h1>
                <p style={{ fontSize: "1.1rem", color: MUTED, marginBottom: "2.5rem", lineHeight: 1.7, maxWidth: 420 }}>{d.slogan || d.descripcion}</p>
                <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
                    <button className="btn-primary" style={{ padding: "1rem 2rem", fontSize: "0.95rem", borderRadius: "16px" }} onClick={() => scrollTo("contacto")}>Agendar Consulta</button>
                    <button className="btn-outline" style={{ padding: "1rem 2rem", fontSize: "0.95rem", borderRadius: "16px" }} onClick={() => scrollTo("servicios")}>Conocer Servicios</button>
                </div>
            </div>
    ...
    return (
        <section id="inicio" style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: BG, borderBottom: `3px solid ${primary}`, overflow: "hidden" }}>
            <div style={{ textAlign: "center", padding: "0 1.5rem", maxWidth: 900 }}>
                ...
                <h1 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "clamp(3.5rem, 10vw, 7rem)", fontWeight: 700, lineHeight: 0.95, letterSpacing: "-0.03em", textTransform: "capitalize", marginBottom: "2rem", color: TEXT }}>
                    {d.nombre}
                </h1>
        ...
        <div className="grid-2" style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: "1.5rem" }}>
            {(d.servicios || []).map((s, i) => (
                <AnimatedSection key={i} delay={i * 100}>
                    <div className="service-card" style={{ background: BG2, border: `2px solid ${BORDER}`, borderRadius: "20px", overflow: "hidden", transition: "all 0.3s", padding: "2rem", cursor: "pointer" }}
                        onMouseOver={e => { e.currentTarget.style.borderColor = primary; e.currentTarget.style.transform = "translateY(-8px)"; e.currentTarget.style.boxShadow = `0 12px 32px rgba(${primaryRgb},0.12)`; }}
                        ...
                        <div style={{ width: 60, height: 60, background: `rgba(${primaryRgb},0.1)`, border: `2px solid rgba(${primaryRgb},0.2)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, marginBottom: "1.5rem", borderRadius: "16px" }}>
                            <span style={{ width: 28, height: 28 }}>{Icons[s.icon] || Icons.heart}</span>
                        </div>
                        <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1.3rem", fontWeight: 700, textTransform: "capitalize", letterSpacing: "0.02em", marginBottom: "0.75rem", color: TEXT }}>{s.titulo}</h3>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {(d.servicios || []).map((s, i) => (
                <AnimatedSection key={i} delay={i * 80}>
                    <div style={{ display: "flex", alignItems: "center", gap: "2rem", padding: "1.75rem 2rem", background: BG2, border: `2px solid ${BORDER}`, borderLeft: `4px solid ${primary}`, transition: "all 0.3s", borderRadius: "16px" }}
                        onMouseOver={e => e.currentTarget.style.background = `rgba(${primaryRgb},0.03)`}
                        onMouseOut={e => e.currentTarget.style.background = BG2}>
                        <div style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "3rem", fontWeight: 700, color: `rgba(${primaryRgb},0.15)`, minWidth: 60, lineHeight: 1 }}>
                        ...
                        <div>
                            <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1.2rem", fontWeight: 700, textTransform: "capitalize", letterSpacing: "0.02em", marginBottom: "0.3rem", color: TEXT }}>{s.titulo}</h3>
...
function ServiciosFeatured({ d, primary, primaryRgb, fontTitulo, BG, BG2, TEXT, MUTED, BORDER }) {
    ...
    return (
        <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: "1.5rem" }} className="grid-2">
            {featured && (
                <AnimatedSection>
                    <div style={{ background: BG2, border: `2px solid ${BORDER}`, borderRadius: "20px", padding: "3rem 2.5rem", height: "100%" }}>
                        <div style={{ width: 64, height: 64, background: `rgba(${primaryRgb},0.12)`, border: `2px solid rgba(${primaryRgb},0.2)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, marginBottom: "1.5rem", borderRadius: "16px" }}>
                        ...
                        <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "2rem", fontWeight: 700, textTransform: "capitalize", lineHeight: 1.1, marginBottom: "1rem", color: TEXT }}>{featured.titulo}</h3>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                {rest.map((s, i) => (
                    <AnimatedSection key={i} delay={i * 100}>
                        <div style={{ background: BG2, border: `2px solid ${BORDER}`, borderRadius: "16px", padding: "1.5rem", display: "flex", gap: "1rem", alignItems: "flex-start", cursor: "pointer", transition: "all 0.3s" }}
                            ...
                            <div>
                                <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1rem", fontWeight: 700, textTransform: "capitalize", marginBottom: "0.3rem", color: TEXT }}>{s.titulo}</h3>
...
function NosotrosImage({ d, BG, BG2, TEXT, MUTED, BORDER }) {
    return (
        <div style={{ position: "relative", borderRadius: "20px", overflow: "hidden", aspectRatio: "4/3", border: `2px solid ${BORDER}`, boxShadow: "0 8px 32px rgba(0,0,0,0.08)" }}>
            <img
    ...
    return (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
            {[
                ...
                <div key={i} style={{ padding: "2rem", background: BG2, border: `2px solid ${BORDER}`, borderRadius: "16px", borderTop: `4px solid ${primary}` }}>
                    <div style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "2.8rem", fontWeight: 700, color: primary, lineHeight: 1, marginBottom: "0.5rem" }}>{s.n}</div>
                    <div style={{ fontSize: "0.85rem", color: MUTED, textTransform: "uppercase", letterSpacing: "0.08em", fontWeight: 500 }}>{s.l}</div>
                </div>
            ))}
        </div>
    );
...
export default function LandingPsicologia({ data, onEnter }) {
    ...
    const primary = d.color_primario || '#a4793f';
    const secondary = d.color_secundario || '#8b6f47';
    ...
    const iniciales = (d.nombre || "PS").split(" ").slice(0, 2).map(w => w[0]).join("").toUpperCase();
        ...
        <div style={{ fontFamily: `'${fontCuerpo}', sans-serif`, background: BG, color: TEXT, overflowX: "hidden" }}>
            <style>{`
                ...
                * { margin: 0; padding: 0; box-sizing: border-box; }
                ...
                .btn-primary { background: ${primary}; color: #fff; border: none; cursor: pointer; font-family: '${fontTitulo}', serif; font-weight: 700; letter-spacing: 0.08em; text-transform: capitalize; transition: all 0.2s; }
                .btn-primary:hover { background: ${secondary}; transform: translateY(-2px); box-shadow: 0 8px 24px rgba(${primaryRgb},0.25); }
                .btn-outline { background: transparent; color: ${primary}; border: 2px solid ${primary}; cursor: pointer; font-family: '${fontTitulo}', serif; font-weight: 700; letter-spacing: 0.08em; text-transform: capitalize; transition: all 0.2s; }
                .btn-outline:hover { background: ${primary}; color: #fff; }
                .service-card { background: ${BG2}; border: 2px solid ${BORDER}; border-radius: 20px; }
                .testim-card { background: ${BG2}; border: 2px solid ${BORDER}; border-radius: 16px; padding: 2rem; transition: all 0.3s; }
                .testim-card:hover { border-color: ${primary}; box-shadow: 0 8px 32px rgba(${primaryRgb},0.12); }
                ...
                input, textarea { background: ${BG}; border: 2px solid ${BORDER}; color: ${TEXT}; font-family: '${fontCuerpo}', sans-serif; font-size: 0.95rem; padding: 0.85rem 1rem; width: 100%; outline: none; border-radius: 12px; transition: border-color 0.2s; }
            ...
            <nav style={{
                ...
                padding: "1rem 2rem",
                background: scrolled ? `rgba(${primaryRgb},0.05)` : "transparent",
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", cursor: "pointer" }} onClick={() => scrollTo("inicio")}>
                    <div style={{ width: 40, height: 40, background: primary, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', serif`, fontWeight: 700, fontSize: "1rem", letterSpacing: "0.05em", color: "#fff", borderRadius: "12px" }}>{iniciales}</div>
                    <span style={{ fontFamily: `'${fontTitulo}', serif`, fontWeight: 700, fontSize: "1.1rem", letterSpacing: "0.05em", textTransform: "capitalize", color: TEXT }}>{d.nombre}</span>
                </div>
                <div className="desktop-nav" style={{ display: "flex", alignItems: "center", gap: "2.5rem" }}>
                    ...
                    <button className="btn-primary" style={{ padding: "0.6rem 1.4rem", fontSize: "0.85rem", borderRadius: "12px" }} onClick={() => scrollTo("contacto")}>Agendar Consulta</button>
                </div>
            ...
            {menuOpen && (
                <div style={{ position: "fixed", top: 65, left: 0, right: 0, zIndex: 999, background: BG, borderBottom: `1px solid ${BORDER}`, padding: "1.5rem 2rem", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                    ...
                    <button className="btn-primary" style={{ padding: "0.8rem", fontSize: "0.9rem", borderRadius: "12px" }} onClick={() => scrollTo("contacto")}>Agendar Consulta</button>
                </div>
            )}
            ...
            <section style={{ background: primary, padding: "2rem" }}>
                <div className="stats-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", maxWidth: 900, margin: "0 auto", textAlign: "center", gap: "1rem" }}>
                    {[
                        ...
                        <div key={i}>
                            <div style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "2.2rem", fontWeight: 700, letterSpacing: "-0.02em", color: "#fff" }}>{s.n}</div>
            ...
            <section id="servicios" style={{ background: BG2, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 700, textTransform: "capitalize", letterSpacing: "-0.01em", marginBottom: "3.5rem", color: TEXT }}>Nuestros Servicios</h2>
                    </AnimatedSection>
                    {(() => {
                        if (d.servicios_variant === "list") return <ServiciosList {...variantProps} />;
                        if (d.servicios_variant === "featured") return <ServiciosFeatured {...variantProps} />;
                        return <ServiciosGrid {...variantProps} />;
                    })()}
                </div>
            </section>
            ...
            <section id="nosotros" style={{ background: BG, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }} className="grid-2">
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "clamp(2rem,4vw,2.8rem)", fontWeight: 700, textTransform: "capitalize", lineHeight: 1.1, marginBottom: "1.5rem", color: TEXT }}>Bienestar mental con enfoque integral</h2>
                        <p style={{ color: MUTED, lineHeight: 1.7, marginBottom: "2rem" }}>{d.descripcion}</p>
                        <button className="btn-primary" style={{ padding: "0.9rem 2rem", fontSize: "0.9rem", borderRadius: "12px" }} onClick={() => scrollTo("contacto")}>Contáctanos hoy</button>
                    </AnimatedSection>
                    <AnimatedSection delay={150}>
                        {(() => {
                            if (d.nosotros_variant === "stats") return <NosotrosStats {...variantProps} />;
                            return <NosotrosImage {...variantProps} />;
                        })()}
                    </AnimatedSection>
                </div>
            </section>
            ...
            <section id="testimonios" style={{ background: BG2, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 700, textTransform: "capitalize", marginBottom: "3.5rem", color: TEXT }}>Lo que dicen de nosotros</h2>
                    </AnimatedSection>
                            ...
                            <AnimatedSection key={i} delay={i * 120}>
                                <div className="testim-card">
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                                        <div style={{ width: 44, height: 44, background: primary, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', serif`, fontWeight: 700, fontSize: "1.1rem", color: "#fff", borderRadius: "12px" }}>
            ...
            <section id="contacto" style={{ background: BG, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 700, textTransform: "capitalize", marginBottom: "3.5rem", color: TEXT }}>Hablemos sobre tu bienestar</h2>
                    </AnimatedSection>
                    <div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: "4rem", alignItems: "start" }}>
                        <AnimatedSection>
                            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                                {[
                                    ...
                                    <div key={i} style={{ display: "flex", gap: "1rem", alignItems: "flex-start", padding: "1.25rem", background: BG2, border: `2px solid ${BORDER}`, borderRadius: "12px" }}>
                                        <div style={{ width: 42, height: 42, minWidth: 42, background: `rgba(${primaryRgb},0.1)`, border: `2px solid rgba(${primaryRgb},0.2)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, borderRadius: "10px" }}>
                                            <span style={{ width: 20, height: 20 }}>{Icons[item.icon]}</span>
                                        </div>
                                        <div>
                                            <div style={{ fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.1em", color: MUTED, marginBottom: "0.25rem", fontWeight: 600 }}>{item.label}</div>
                                            <div style={{ fontWeight: 500, color: TEXT }}>{item.value}</div>
                                        </div>
                                    </div>
                                ))}
                                <a href={waLink} target="_blank" rel="noopener noreferrer"
                                    style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.75rem", background: "#25d366", color: "#fff", padding: "1rem", fontFamily: `'${fontTitulo}', serif`, fontWeight: 700, letterSpacing: "0.08em", textTransform: "capitalize", fontSize: "1rem", transition: "background 0.2s", borderRadius: "12px" }}
                        ...
                        <AnimatedSection delay={150}>
                            <div style={{ background: BG2, border: `2px solid ${BORDER}`, borderRadius: "16px", padding: "2.5rem" }}>
                                <h3 style={{ fontFamily: `'${fontTitulo}', serif`, fontSize: "1.4rem", fontWeight: 700, textTransform: "capitalize", marginBottom: "1.5rem", color: TEXT }}>Envíanos un mensaje</h3>
                                <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <footer style={{ background: BG2, borderTop: `1px solid ${BORDER}`, padding: "3rem 2rem 1.5rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "2rem", paddingBottom: "2rem", borderBottom: `1px solid ${BORDER}`, marginBottom: "1.5rem" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                            <div style={{ width: 36, height: 36, background: primary, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', serif`, fontWeight: 700, color: "#fff", borderRadius: "10px" }}>{iniciales}</div>
                            <span style={{ fontFamily: `'${fontTitulo}', serif`, fontWeight: 700, fontSize: "1rem", textTransform: "capitalize", letterSpacing: "0.05em", color: TEXT }}>{d.nombre}</span>
                        </div>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
                        ...
                        <p style={{ color: "rgba(15,23,42,0.2)", fontSize: "0.75rem", letterSpacing: "0.05em" }}>Powered by Devantai</p>
                    </div>
                </div>
            </footer>
            ...
            {onEnter && (
                <button onClick={onEnter} style={{
                    ...
                    fontSize: "0.95rem", letterSpacing: "0.08em", textTransform: "capitalize",
                    zIndex: 9999, boxShadow: `0 4px 20px rgba(${primaryRgb},0.3)`,
