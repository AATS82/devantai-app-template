...
// ============================================================
// DEVANTAI — LANDING TEMPLATE: VETERINARIA
// Tema: light, Perfil: calido_familiar
...
const DEFAULT_DATA = {
    ...
    color_secundario: "#c89666",
    font_titulo: "Playfair Display",
    font_cuerpo: "Source Sans Pro",
    imagen_hero: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=1800&q=80",
    imagen_nosotros: "https://images.unsplash.com/photo-1516214104703-3237461d7cb7?w=800&q=80",
    servicios: [
        { titulo: "{{SERVICIO_1}}", descripcion: "{{DESC_1}}", icon: "stethoscope" },
        { titulo: "{{SERVICIO_2}}", descripcion: "{{DESC_2}}", icon: "heart" },
        { titulo: "{{SERVICIO_3}}", descripcion: "{{DESC_3}}", icon: "vaccine" },
        { titulo: "{{SERVICIO_4}}", descripcion: "{{DESC_4}}", icon: "paw" },
    ],
    testimonios: [
...
// SVG Icons
const Icons = {
    stethoscope: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4.6 11a6 6 0 0 1 11.8 0M13 16h1a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-7a2 2 0 0 1-2-2v-2a2 2 0 0 1 2-2h1M4 12a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H4z" /></svg>),
    ...
    vaccine: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M2 12h20M6 9l12 6M18 9l-12 6" /></svg>),
    paw: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="13" r="2"/><circle cx="19" cy="18" r="2"/><circle cx="20" cy="7" r="2"/><circle cx="5" cy="18" r="2"/><circle cx="4" cy="8" r="2"/><path d="M12 13v8M19 18v-5M20 7v6M5 18v-5M4 8v6" /></svg>),
...
function HeroCentered({ d, primary, primaryRgb, fontTitulo, scrollTo, BG, BG2, TEXT, MUTED, BORDER }) {
    return (
        <section id="inicio" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", background: BG }}>
            <div style={{ position: "absolute", inset: 0, backgroundImage: `url('${d.imagen_hero}')`, backgroundSize: "cover", backgroundPosition: "center", filter: "brightness(0.5)" }} />
            ...
            <div style={{ position: "relative", textAlign: "center", padding: "0 1.5rem", maxWidth: 780, zIndex: 1 }}>
                <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: `rgba(${primaryRgb},0.15)`, border: `1px solid rgba(${primaryRgb},0.4)`, padding: "0.4rem 1rem", borderRadius: "20px", marginBottom: "1.5rem", fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 600, fontSize: "0.8rem", letterSpacing: "0.15em", textTransform: "uppercase", color: primary }}>
                    ★ {d.anos_experiencia} años cuidando mascotas ★
                </div>
                <h1 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "clamp(3rem, 8vw, 5.5rem)", fontWeight: 800, lineHeight: 1.0, letterSpacing: "-0.01em", marginBottom: "1.25rem", textTransform: "uppercase", color: "#fff" }}>{d.nombre}</h1>
        ...
        <div className="grid-2" style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: "1.5rem" }}>
            {(d.servicios || []).map((s, i) => (
                <AnimatedSection key={i} delay={i * 100}>
                    <div className="service-card" style={{ background: BG2, border: `1px solid ${BORDER}`, borderRadius: "20px", overflow: "hidden", transition: "all 0.3s" }}>
                        <div className="card-accent" />
                        <div style={{ padding: "2rem", display: "flex", gap: "1.5rem", alignItems: "flex-start" }}>
                            <div style={{ width: 64, height: 64, minWidth: 64, background: `rgba(${primaryRgb},0.15)`, border: `2px solid rgba(${primaryRgb},0.3)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, borderRadius: "16px" }}>
                                <span style={{ width: 32, height: 32 }}>{Icons[s.icon] || Icons.stethoscope}</span>
                            </div>
                            <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {(d.servicios || []).map((s, i) => (
                <AnimatedSection key={i} delay={i * 80}>
                    <div style={{ display: "flex", alignItems: "center", gap: "2rem", padding: "1.75rem 2rem", background: BG2, border: `1px solid ${BORDER}`, borderLeft: `4px solid ${primary}`, borderRadius: "16px", transition: "all 0.3s" }}
                        ...
                        <div style={{ width: 40, height: 40, minWidth: 40, color: primary }}>
                            <span style={{ width: 28, height: 28, display: "block" }}>{Icons[s.icon] || Icons.stethoscope}</span>
                        </div>
                        <div>
    ...
    return (
        <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: "1.5rem" }} className="grid-2">
                ...
                <AnimatedSection>
                    <div className="service-card" style={{ height: "100%", background: BG2, border: `1px solid ${BORDER}`, borderRadius: "20px", overflow: "hidden" }}>
                        ...
                        <div style={{ padding: "3rem 2.5rem" }}>
                            <div style={{ width: 80, height: 80, background: `rgba(${primaryRgb},0.15)`, border: `2px solid rgba(${primaryRgb},0.4)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, marginBottom: "1.5rem", borderRadius: "16px" }}>
                                <span style={{ width: 40, height: 40 }}>{Icons[featured.icon] || Icons.stethoscope}</span>
                            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                {rest.map((s, i) => (
                    <AnimatedSection key={i} delay={i * 100}>
                        <div className="service-card" style={{ background: BG2, border: `1px solid ${BORDER}`, borderRadius: "20px", overflow: "hidden" }}>
                            <div className="card-accent" />
                            <div style={{ padding: "1.5rem", display: "flex", gap: "1rem", alignItems: "flex-start" }}>
                                <div style={{ width: 48, height: 48, minWidth: 48, background: `rgba(${primaryRgb},0.1)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, borderRadius: "12px" }}>
                                    <span style={{ width: 24, height: 24 }}>{Icons[s.icon] || Icons.stethoscope}</span>
                                </div>
                                <div>
    ...
    return (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
            {[
                ...
                <div key={i} style={{ padding: "2rem", background: BG2, border: `2px solid ${BORDER}`, borderTop: `4px solid ${primary}`, borderRadius: "16px" }}>
...
export default function LandingVeterinaria({ data, onEnter }) {
    const d = data || DEFAULT_DATA;
    const [scrolled, setScrolled] = useState(false);
    const [menuOpen, setMenuOpen] = useState(false);

    const isDark = (d.tema || 'light') === 'dark';
    const BG = isDark ? '#1a1a1e' : '#fffef9';
    const BG2 = isDark ? '#252529' : '#f8f5f0';
    const BG3 = isDark ? '#2d2d31' : '#f0ede8';
    const TEXT = isDark ? '#f0f0f0' : '#2a2a2a';
    const MUTED = isDark ? 'rgba(240,240,240,0.6)' : 'rgba(42,42,42,0.6)';
    const BORDER = isDark ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.08)';

    const primary = d.color_primario || '#d4a574';
    const secondary = d.color_secundario || '#c89666';
    ...
    const iniciales = (d.nombre || "VET").split(" ").slice(0, 2).map(w => w[0]).join("").toUpperCase();
    const waLink = `https://wa.me/${(d.telefono || "").replace(/\D/g, "")}`;

    const variantProps = { d, primary, primaryRgb, fontTitulo, fontCuerpo, scrollTo, BG, BG2, BG3, TEXT, MUTED, BORDER };
        ...
        <div style={{ fontFamily: `'${fontCuerpo}', sans-serif`, background: BG, color: TEXT, overflowX: "hidden" }}>
            <style>{`
                ...
                * { margin: 0; padding: 0; box-sizing: border-box; }
                ...
                .btn-primary:hover { background: var(--primary-dark); transform: translateY(-2px); box-shadow: 0 12px 30px rgba(${primaryRgb},0.25); }
                .btn-outline { background: transparent; color: ${primary}; border: 2px solid ${primary}; cursor: pointer; font-family: '${fontTitulo}', sans-serif; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; transition: all 0.2s; }
                .btn-outline:hover { background: ${primary}; color: #fff; }
                .service-card { background: var(--bg2); border: 1px solid var(--border); border-radius: 20px; overflow: hidden; transition: all 0.3s; }
                .service-card:hover { border-color: var(--primary); transform: translateY(-4px); box-shadow: 0 16px 40px rgba(${primaryRgb},0.12); }
                .service-card:hover .card-accent { width: 100%; }
                .card-accent { height: 3px; background: var(--primary); width: 0; transition: width 0.4s ease; }
                .testim-card { background: var(--bg2); border: 1px solid var(--border); border-radius: 20px; padding: 2rem; transition: all 0.3s; }
                .testim-card:hover { border-color: var(--primary); box-shadow: 0 12px 30px rgba(${primaryRgb},0.12); }
                .why-item { display: flex; gap: 1.25rem; align-items: flex-start; padding: 1.5rem; border-left: 3px solid transparent; transition: border-color 0.3s, background 0.3s; border-radius: 12px; }
                ...
                <div className="stats-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", maxWidth: 1000, margin: "0 auto", textAlign: "center", gap: "2rem" }}>
                    {[
                        ...
                        <div key={i}>
                            ...
                            <div style={{ fontSize: "0.85rem", opacity: 0.9, letterSpacing: "0.05em", textTransform: "uppercase", color: "#fff" }}>{s.l}</div>
                        </div>
                    ))}
                </div>
            </section>
            ...
            <section id="servicios" style={{ background: BG2, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto" }}>
                    ...
                    {(() => {
                        const props = { d, primary, primaryRgb, fontTitulo, BG, BG2, BG3, TEXT, MUTED, BORDER };
            ...
            <section id="nosotros" style={{ background: BG, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }} className="grid-2">
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontSize: "clamp(2rem,4vw,2.8rem)", fontWeight: 800, textTransform: "uppercase", lineHeight: 1.1, marginBottom: "1.5rem", color: TEXT }}>Cuidado profesional para tus mascotas</h2>
                            ...
                            <AnimatedSection key={i} delay={i * 120}>
                                <div className="testim-card">
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
                                        <div style={{ width: 56, height: 56, background: primary, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 800, fontSize: "1.3rem", color: "#fff", borderRadius: "14px" }}>
            ...
            <section id="contacto" style={{ background: BG, padding: "6rem 2rem" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <AnimatedSection>
                        ...
                        <h2 style={{ fontFamily: `'${fontTitulo}', sans-serif`, textAlign: "center", fontSize: "clamp(2rem,5vw,3rem)", fontWeight: 800, textTransform: "uppercase", marginBottom: "3.5rem", color: TEXT }}>¿Necesitas agendar una cita?</h2>
                    </AnimatedSection>
                        ...
                        <AnimatedSection>
                            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                                {[
                                    ...
                                    <div key={i} style={{ display: "flex", gap: "1rem", alignItems: "flex-start", padding: "1.5rem", background: BG2, border: `1px solid ${BORDER}`, borderRadius: "16px" }}>
                                        <div style={{ width: 50, height: 50, minWidth: 50, background: `rgba(${primaryRgb},0.15)`, border: `2px solid rgba(${primaryRgb},0.3)`, display: "flex", alignItems: "center", justifyContent: "center", color: primary, borderRadius: "12px" }}>
                                ...
                                <a href={waLink} target="_blank" rel="noopener noreferrer"
                                    style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.75rem", background: "#25d366", color: "#fff", padding: "1.2rem", fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", fontSize: "1rem", transition: "all 0.2s", borderRadius: "12px" }}
                        ...
                        <AnimatedSection delay={150}>
                            <div style={{ background: BG2, border: `2px solid ${BORDER}`, padding: "2.5rem", borderRadius: "20px" }}>
                                ...
                                <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                                    ...
                                    <input type="text" placeholder="Mascota" style={{ color: TEXT }} />
                ...
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "2rem", paddingBottom: "2rem", borderBottom: `1px solid ${BORDER}`, marginBottom: "1.5rem" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                            <div style={{ width: 40, height: 40, background: primary, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 800, color: "#fff", borderRadius: "10px" }}>{iniciales}</div>
                            <span style={{ fontFamily: `'${fontTitulo}', sans-serif`, fontWeight: 700, fontSize: "1.1rem", textTransform: "uppercase", letterSpacing: "0.05em", color: TEXT }}>{d.nombre}</span>
                        </div>
            ...
            {onEnter && (
                <button onClick={onEnter} style={{
                    ...
                    zIndex: 9999, boxShadow: `0 12px 30px rgba(${primaryRgb},0.25)`,
